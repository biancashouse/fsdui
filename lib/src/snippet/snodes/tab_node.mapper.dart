...
class TabNodeMapper extends SubClassMapperBase<TabNode> {
  ...
  static const Field<TabNode, Widget> _f$icon = Field(
    'icon',
    _$icon,
    opt: true,
  );
  static EdgeInsetsValue? _$iconMargin(TabNode v) => v.iconMargin;
  static const Field<TabNode, EdgeInsetsValue> _f$iconMargin = Field(
    'iconMargin',
    _$iconMargin,
    opt: true,
  );
  static double? _$height(TabNode v) => v.height;
  static const Field<TabNode, double> _f$height = Field(
    'height',
    _$height,
    opt: true,
  );
  static SNode? _$child(TabNode v) => v.child;
  static const Field<TabNode, SNode> _f$child = Field(
    'child',
    _$child,
    opt: true,
  );
  static String _$uid(TabNode v) => v.uid;
  static const Field<TabNode, String> _f$uid = Field(
    'uid',
    _$uid,
  ...
  static const Field<TabNode, bool> _f$isExpanded = Field(
    'isExpanded',
    _$isExpanded,
    mode: FieldMode.member,
  );
  ...
  static GlobalKey<State<StatefulWidget>>? _$nodeGK(TabNode v) => v.nodeGK;
  static const Field<TabNode, GlobalKey<State<StatefulWidget>>> _f$nodeGK =
      Field('nodeGK', _$nodeGK, mode: FieldMode.member);
  static bool _$canShowTappableNodeWidgetOverlay(TabNode v) =>
      v.canShowTappableNodeWidgetOverlay;
  static const Field<TabNode, bool> _f$canShowTappableNodeWidgetOverlay = Field(
    'canShowTappableNodeWidgetOverlay',
    _$canShowTappableNodeWidgetOverlay,
    mode: FieldMode.member,
  );
  static GlobalKey<State<StatefulWidget>>? _$nodeWidgetGK(TabNode v) =>
      v.nodeWidgetGK;
  static const Field<TabNode, GlobalKey<State<StatefulWidget>>>
...
mixin TabNodeMappable {
  String toJson() {
    return TabNodeMapper.ensureInitialized().encodeJson<TabNode>(
      this as TabNode,
    );
  }

  Map<String, dynamic> toMap() {
    return TabNodeMapper.ensureInitialized().encodeMap<TabNode>(
      this as TabNode,
    );
  }
  ...
  bool operator ==(Object other) {
    return TabNodeMapper.ensureInitialized().equalsValue(
      this as TabNode,
      other,
    );
  }
