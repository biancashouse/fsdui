...
// }
//
// class _PointingLineState extends State<PointingLine>
...
//         duration: Duration(milliseconds: widget.pointingAnimationDuration),
//         vsync: this,
//       );
//
...
//     final Rect lineBounds = Rect.fromPoints(widget.from, widget.to);
//
//     // 2. Translate the line coordinates to be relative to the top-left
//     //    of the bounding rectangle.
//     final Offset localFrom = widget.from.translate(
//       -lineBounds.left,
//       -lineBounds.top,
//     );
//     final Offset localTo = widget.to.translate(
//       -lineBounds.left,
//       -lineBounds.top,
//     );
//
//     bool wavyLine = widget.pointerType == TargetPointerType.wavy_line();
//     if (wavyLine) {
//       print('wavy');
//     }
//     return wavyLine
//         ? Container(
//             width: lineBounds.width, height: lineBounds.height,
//           child: CustomPaint(
...
//               from: localFrom,
//               to: localTo,
//               lengthDeltaPc: widget.lengthDeltaPc,
