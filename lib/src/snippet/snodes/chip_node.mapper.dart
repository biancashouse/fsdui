...
class ChipNodeMapper extends SubClassMapperBase<ChipNode> {
  ...
  static const Field<ChipNode, EdgeInsets> _f$labelPadding = Field(
    'labelPadding',
    _$labelPadding,
    opt: true,
  );
  static Color? _$bgColor(ChipNode v) => v.bgColor;
  static const Field<ChipNode, Color> _f$bgColor = Field(
    'bgColor',
    _$bgColor,
    opt: true,
  );
  static Color? _$disabledColor(ChipNode v) => v.disabledColor;
  static const Field<ChipNode, Color> _f$disabledColor = Field(
    'disabledColor',
    _$disabledColor,
    opt: true,
  );
  static Color? _$selectedColor(ChipNode v) => v.selectedColor;
  static const Field<ChipNode, Color> _f$selectedColor = Field(
    'selectedColor',
    _$selectedColor,
    opt: true,
  );
