...
class UMLImageNodeMapper extends SubClassMapperBase<UMLImageNode> {
  ...
  static const Field<UMLImageNode, String> _f$diagramText =
      Field('diagramText', _$diagramText, opt: true);
  ...
  static const Field<UMLImageNode, double> _f$scale =
      Field('scale', _$scale, opt: true, def: 1.0);
  static BoxFitEnum? _$fit(UMLImageNode v) => v.fit;
  static const Field<UMLImageNode, BoxFitEnum> _f$fit =
      Field('fit', _$fit, opt: true, def: BoxFitEnum.none);
  static AlignmentEnum? _$alignment(UMLImageNode v) => v.alignment;
  static const Field<UMLImageNode, AlignmentEnum> _f$alignment =
      Field('alignment', _$alignment, opt: true, def: AlignmentEnum.center);
  ...
  static const Field<UMLImageNode, List<String>> _f$tags =
