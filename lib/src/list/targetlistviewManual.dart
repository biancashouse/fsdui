...
//   }
//
//   static Future<void> clearSelection(final ImageWrapperManualState parent, {required TargetModel tappedTc}) async {
...
//     TargetModel selectedTc = parent.bloc.state.selectedTarget(parent.widget.name)!;
