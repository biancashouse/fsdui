...
class ElevatedButtonNodeMapper extends SubClassMapperBase<ElevatedButtonNode> {
  ...
  static const Field<ElevatedButtonNode, String> _f$name =
  ...
  static const Field<ElevatedButtonNode, List<String>> _f$tags =
  ...
  static GlobalKey<State<StatefulWidget>>? _$nodeGK(ElevatedButtonNode v) =>
      v.nodeGK;
  static const Field<ElevatedButtonNode, GlobalKey<State<StatefulWidget>>>
