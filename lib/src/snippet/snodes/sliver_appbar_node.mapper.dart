...
class SliverAppBarNodeMapper extends SubClassMapperBase<SliverAppBarNode> {
  ...
  static const Field<SliverAppBarNode, Color> _f$bgColor = Field(
    'bgColor',
    _$bgColor,
    opt: true,
  );
  static Color? _$fgColor(SliverAppBarNode v) => v.fgColor;
  static const Field<SliverAppBarNode, Color> _f$fgColor = Field(
    'fgColor',
    _$fgColor,
    opt: true,
  );
  ...
  static const Field<SliverAppBarNode, Color> _f$shadowColor = Field(
    'shadowColor',
    _$shadowColor,
    opt: true,
  );
