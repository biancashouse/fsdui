...
class SliverFloatingHeaderNodeMapper
  ...
  static SliverFloatingHeaderNodeMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = SliverFloatingHeaderNodeMapper._());
  ...
  static const Field<SliverFloatingHeaderNode, String> _f$name =
      Field('name', _$name, opt: true);
  static SNode? _$child(SliverFloatingHeaderNode v) => v.child;
  static const Field<SliverFloatingHeaderNode, SNode> _f$child =
      Field('child', _$child, opt: true);
  static String _$uid(SliverFloatingHeaderNode v) => v.uid;
  static const Field<SliverFloatingHeaderNode, String> _f$uid =
      Field('uid', _$uid, mode: FieldMode.member);
  static List<String>? _$tags(SliverFloatingHeaderNode v) => v.tags;
  static const Field<SliverFloatingHeaderNode, List<String>> _f$tags =
  ...
  static const Field<SliverFloatingHeaderNode, bool> _f$isExpanded =
...
mixin SliverFloatingHeaderNodeMappable {
  ...
  SliverFloatingHeaderNodeCopyWith<SliverFloatingHeaderNode,
          SliverFloatingHeaderNode, SliverFloatingHeaderNode>
      get copyWith => _SliverFloatingHeaderNodeCopyWithImpl<
              SliverFloatingHeaderNode, SliverFloatingHeaderNode>(
          this as SliverFloatingHeaderNode, $identity, $identity);
  @override
  String toString() {
    return SliverFloatingHeaderNodeMapper.ensureInitialized()
        .stringifyValue(this as SliverFloatingHeaderNode);
  }

  @override
  bool operator ==(Object other) {
    return SliverFloatingHeaderNodeMapper.ensureInitialized()
        .equalsValue(this as SliverFloatingHeaderNode, other);
  }

  @override
  int get hashCode {
    return SliverFloatingHeaderNodeMapper.ensureInitialized()
        .hashValue(this as SliverFloatingHeaderNode);
  }
}
...
extension SliverFloatingHeaderNodeValueCopy<$R, $Out>
  ...
  SliverFloatingHeaderNodeCopyWith<$R, SliverFloatingHeaderNode, $Out>
      get $asSliverFloatingHeaderNode => $base.as((v, t, t2) =>
          _SliverFloatingHeaderNodeCopyWithImpl<$R, $Out>(v, t, t2));
}
