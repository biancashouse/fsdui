...
class FlexibleSpaceBarNodeMapper
  ...
  static const Field<FlexibleSpaceBarNode, String> _f$name =
      Field('name', _$name, opt: true);
  static NamedSC _$title(FlexibleSpaceBarNode v) => v.title;
  static const Field<FlexibleSpaceBarNode, NamedSC> _f$title =
      Field('title', _$title);
  static NamedSC _$background(FlexibleSpaceBarNode v) => v.background;
  static const Field<FlexibleSpaceBarNode, NamedSC> _f$background =
      Field('background', _$background);
  static bool? _$centerTitle(FlexibleSpaceBarNode v) => v.centerTitle;
  static const Field<FlexibleSpaceBarNode, bool> _f$centerTitle =
      Field('centerTitle', _$centerTitle, opt: true);
  static EdgeInsets? _$titlePadding(FlexibleSpaceBarNode v) => v.titlePadding;
  static const Field<FlexibleSpaceBarNode, EdgeInsets> _f$titlePadding =
      Field('titlePadding', _$titlePadding, opt: true);
  static String _$uid(FlexibleSpaceBarNode v) => v.uid;
  static const Field<FlexibleSpaceBarNode, String> _f$uid =
      Field('uid', _$uid, mode: FieldMode.member);
  static List<String>? _$tags(FlexibleSpaceBarNode v) => v.tags;
  static const Field<FlexibleSpaceBarNode, List<String>> _f$tags =
  ...
  static const Field<FlexibleSpaceBarNode, bool> _f$isExpanded =
  ...
  static GlobalKey<State<StatefulWidget>>? _$nodeGK(FlexibleSpaceBarNode v) =>
      v.nodeGK;
  static const Field<FlexibleSpaceBarNode, GlobalKey<State<StatefulWidget>>>
...
mixin FlexibleSpaceBarNodeMappable {
  ...
  FlexibleSpaceBarNodeCopyWith<FlexibleSpaceBarNode, FlexibleSpaceBarNode,
      FlexibleSpaceBarNode> get copyWith => _FlexibleSpaceBarNodeCopyWithImpl<
          FlexibleSpaceBarNode, FlexibleSpaceBarNode>(
      this as FlexibleSpaceBarNode, $identity, $identity);
  @override
  String toString() {
    return FlexibleSpaceBarNodeMapper.ensureInitialized()
        .stringifyValue(this as FlexibleSpaceBarNode);
  }

  @override
  bool operator ==(Object other) {
    return FlexibleSpaceBarNodeMapper.ensureInitialized()
        .equalsValue(this as FlexibleSpaceBarNode, other);
  }

  @override
  int get hashCode {
    return FlexibleSpaceBarNodeMapper.ensureInitialized()
        .hashValue(this as FlexibleSpaceBarNode);
  }
}
