...
mixin _$AuthStateModel {
  ...
  String? get email =>
      throw _privateConstructorUsedError; // if has a token && unauthenticated: means awaiting confirmation
...
abstract class $AuthStateModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({AuthStatus status, String? email, String token});
}
...
class _$AuthStateModelImpl implements _AuthStateModel {
  ...
  @override
  String toString() {
    return 'AuthStateModel(status: $status, email: $email, token: $token)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, status, email, token);
...
abstract class _AuthStateModel implements AuthStateModel {
  ...
  @override
  String? get email; // if has a token && unauthenticated: means awaiting confirmation
  @override
  String get token;
