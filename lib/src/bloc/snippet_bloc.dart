...
//     MaterialSPA.capiBloc.add(CAPIEvent.updateClipboard(newContent: event.node, skipSave: event.skipSave));
//   }
//
...
//         const (RichTextNode) => RichTextNode(text: TextSpanNode(text: 'abc')),
