...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( SignedInAsSuperEditor value)?  signedInAsSuperEditor,TResult Function( SignedInAsArticleEditor value)?  signedInAsArticleEditor,TResult Function( SignedInAsGuestEditor value)?  signedInAsGuestEditor,TResult Function( SignedOut value)?  signedOut,TResult Function( OverrideTargetGK value)?  overrideTargetGK,TResult Function( ForceRefresh value)?  forceRefresh,TResult Function( ToggleSnippetVisibility value)?  toggleSnippetVisibility,TResult Function( ClearClipboard value)?  clearClipboard,TResult Function( PublishSnippet value)?  publishSnippet,TResult Function( RevertSnippet value)?  revertSnippet,TResult Function( DeletePage value)?  deletePage,TResult Function( ToggleAutoPublishingOfSnippet value)?  toggleAutoPublishingOfSnippet,TResult Function( AutoPublishDefault value)?  autoPublishDefault,TResult Function( SetPanelSnippet value)?  setPanelOrPlaceholderSnippet,TResult Function( EnterSelectWidgetMode value)?  enterNodeSelectionMode,TResult Function( UpdateTappableRects value)?  updateTappableRects,TResult Function( ExitSelectWidgetMode value)?  exitNodeSelectionMode,TResult Function( PushSnippetEditor value)?  pushSnippetEditor,TResult Function( ChangedSnippet value)?  changedSnippet,TResult Function( PopSnippetEditor value)?  popSnippetEditor,TResult Function( ShowDirectoryTree value)?  showDirectoryTree,TResult Function( RemoveDirectoryTree value)?  removeDirectoryTree,TResult Function( SelectNode value)?  selectNode,TResult Function( ClearNodeSelection value)?  clearNodeSelection,TResult Function( SaveNodeAsSnippet value)?  saveNodeAsSnippet,TResult Function( ReplaceSelectionWith value)?  replaceSelectionWith,TResult Function( WrapSelectionWith value)?  wrapSelectionWith,TResult Function( AppendChild value)?  appendChild,TResult Function( PrependArticle value)?  prependArticle,TResult Function( AddSiblingBefore value)?  addSiblingBefore,TResult Function( AddSiblingAfter value)?  addSiblingAfter,TResult Function( PasteReplacement value)?  pasteReplacement,TResult Function( PasteChild value)?  pasteChild,TResult Function( PasteSiblingBefore value)?  pasteSiblingBefore,TResult Function( PasteSiblingAfter value)?  pasteSiblingAfter,TResult Function( DeleteNodeTapped value)?  deleteNodeTapped,TResult Function( DeleteArticle value)?  deleteArticle,TResult Function( CompleteDeletion value)?  completeDeletion,TResult Function( CopySnippetJsonToClipboard value)?  copySnippetJsonToClipboard,TResult Function( ReplaceSnippetFromJson value)?  replaceSnippetFromJson,TResult Function( CopyNode value)?  copyNode,TResult Function( CutNode value)?  cutNode,TResult Function( SelectedDirectoryOrNode value)?  selectedDirectoryOrNode,TResult Function( ImageChanged value)?  imageChanged,TResult Function( Undo value)?  undo,TResult Function( Redo value)?  redo,TResult Function( ForceSnippetRefresh value)?  forceSnippetRefresh,required TResult orElse(),}){
final _that = this;
switch (_that) {
case SignedInAsSuperEditor() when signedInAsSuperEditor != null:
return signedInAsSuperEditor(_that);case SignedInAsArticleEditor() when signedInAsArticleEditor != null:
return signedInAsArticleEditor(_that);case SignedInAsGuestEditor() when signedInAsGuestEditor != null:
return signedInAsGuestEditor(_that);case SignedOut() when signedOut != null:
...
return toggleSnippetVisibility(_that);case ClearClipboard() when clearClipboard != null:
return clearClipboard(_that);case PublishSnippet() when publishSnippet != null:
...
return setPanelOrPlaceholderSnippet(_that);case EnterSelectWidgetMode() when enterNodeSelectionMode != null:
return enterNodeSelectionMode(_that);case UpdateTappableRects() when updateTappableRects != null:
return updateTappableRects(_that);case ExitSelectWidgetMode() when exitNodeSelectionMode != null:
return exitNodeSelectionMode(_that);case PushSnippetEditor() when pushSnippetEditor != null:
return pushSnippetEditor(_that);case ChangedSnippet() when changedSnippet != null:
return changedSnippet(_that);case PopSnippetEditor() when popSnippetEditor != null:
...
return appendChild(_that);case PrependArticle() when prependArticle != null:
return prependArticle(_that);case AddSiblingBefore() when addSiblingBefore != null:
...
return deleteNodeTapped(_that);case DeleteArticle() when deleteArticle != null:
return deleteArticle(_that);case CompleteDeletion() when completeDeletion != null:
...
return imageChanged(_that);case Undo() when undo != null:
return undo(_that);case Redo() when redo != null:
return redo(_that);case ForceSnippetRefresh() when forceSnippetRefresh != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( SignedInAsSuperEditor value)  signedInAsSuperEditor,required TResult Function( SignedInAsArticleEditor value)  signedInAsArticleEditor,required TResult Function( SignedInAsGuestEditor value)  signedInAsGuestEditor,required TResult Function( SignedOut value)  signedOut,required TResult Function( OverrideTargetGK value)  overrideTargetGK,required TResult Function( ForceRefresh value)  forceRefresh,required TResult Function( ToggleSnippetVisibility value)  toggleSnippetVisibility,required TResult Function( ClearClipboard value)  clearClipboard,required TResult Function( PublishSnippet value)  publishSnippet,required TResult Function( RevertSnippet value)  revertSnippet,required TResult Function( DeletePage value)  deletePage,required TResult Function( ToggleAutoPublishingOfSnippet value)  toggleAutoPublishingOfSnippet,required TResult Function( AutoPublishDefault value)  autoPublishDefault,required TResult Function( SetPanelSnippet value)  setPanelOrPlaceholderSnippet,required TResult Function( EnterSelectWidgetMode value)  enterNodeSelectionMode,required TResult Function( UpdateTappableRects value)  updateTappableRects,required TResult Function( ExitSelectWidgetMode value)  exitNodeSelectionMode,required TResult Function( PushSnippetEditor value)  pushSnippetEditor,required TResult Function( ChangedSnippet value)  changedSnippet,required TResult Function( PopSnippetEditor value)  popSnippetEditor,required TResult Function( ShowDirectoryTree value)  showDirectoryTree,required TResult Function( RemoveDirectoryTree value)  removeDirectoryTree,required TResult Function( SelectNode value)  selectNode,required TResult Function( ClearNodeSelection value)  clearNodeSelection,required TResult Function( SaveNodeAsSnippet value)  saveNodeAsSnippet,required TResult Function( ReplaceSelectionWith value)  replaceSelectionWith,required TResult Function( WrapSelectionWith value)  wrapSelectionWith,required TResult Function( AppendChild value)  appendChild,required TResult Function( PrependArticle value)  prependArticle,required TResult Function( AddSiblingBefore value)  addSiblingBefore,required TResult Function( AddSiblingAfter value)  addSiblingAfter,required TResult Function( PasteReplacement value)  pasteReplacement,required TResult Function( PasteChild value)  pasteChild,required TResult Function( PasteSiblingBefore value)  pasteSiblingBefore,required TResult Function( PasteSiblingAfter value)  pasteSiblingAfter,required TResult Function( DeleteNodeTapped value)  deleteNodeTapped,required TResult Function( DeleteArticle value)  deleteArticle,required TResult Function( CompleteDeletion value)  completeDeletion,required TResult Function( CopySnippetJsonToClipboard value)  copySnippetJsonToClipboard,required TResult Function( ReplaceSnippetFromJson value)  replaceSnippetFromJson,required TResult Function( CopyNode value)  copyNode,required TResult Function( CutNode value)  cutNode,required TResult Function( SelectedDirectoryOrNode value)  selectedDirectoryOrNode,required TResult Function( ImageChanged value)  imageChanged,required TResult Function( Undo value)  undo,required TResult Function( Redo value)  redo,required TResult Function( ForceSnippetRefresh value)  forceSnippetRefresh,}){
final _that = this;
switch (_that) {
case SignedInAsSuperEditor():
return signedInAsSuperEditor(_that);case SignedInAsArticleEditor():
return signedInAsArticleEditor(_that);case SignedInAsGuestEditor():
return signedInAsGuestEditor(_that);case SignedOut():
...
return toggleSnippetVisibility(_that);case ClearClipboard():
return clearClipboard(_that);case PublishSnippet():
...
return enterNodeSelectionMode(_that);case UpdateTappableRects():
return updateTappableRects(_that);case ExitSelectWidgetMode():
return exitNodeSelectionMode(_that);case PushSnippetEditor():
return pushSnippetEditor(_that);case ChangedSnippet():
return changedSnippet(_that);case PopSnippetEditor():
...
return appendChild(_that);case PrependArticle():
return prependArticle(_that);case AddSiblingBefore():
...
return deleteNodeTapped(_that);case DeleteArticle():
return deleteArticle(_that);case CompleteDeletion():
...
return imageChanged(_that);case Undo():
return undo(_that);case Redo():
return redo(_that);case ForceSnippetRefresh():
return forceSnippetRefresh(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( SignedInAsSuperEditor value)?  signedInAsSuperEditor,TResult? Function( SignedInAsArticleEditor value)?  signedInAsArticleEditor,TResult? Function( SignedInAsGuestEditor value)?  signedInAsGuestEditor,TResult? Function( SignedOut value)?  signedOut,TResult? Function( OverrideTargetGK value)?  overrideTargetGK,TResult? Function( ForceRefresh value)?  forceRefresh,TResult? Function( ToggleSnippetVisibility value)?  toggleSnippetVisibility,TResult? Function( ClearClipboard value)?  clearClipboard,TResult? Function( PublishSnippet value)?  publishSnippet,TResult? Function( RevertSnippet value)?  revertSnippet,TResult? Function( DeletePage value)?  deletePage,TResult? Function( ToggleAutoPublishingOfSnippet value)?  toggleAutoPublishingOfSnippet,TResult? Function( AutoPublishDefault value)?  autoPublishDefault,TResult? Function( SetPanelSnippet value)?  setPanelOrPlaceholderSnippet,TResult? Function( EnterSelectWidgetMode value)?  enterNodeSelectionMode,TResult? Function( UpdateTappableRects value)?  updateTappableRects,TResult? Function( ExitSelectWidgetMode value)?  exitNodeSelectionMode,TResult? Function( PushSnippetEditor value)?  pushSnippetEditor,TResult? Function( ChangedSnippet value)?  changedSnippet,TResult? Function( PopSnippetEditor value)?  popSnippetEditor,TResult? Function( ShowDirectoryTree value)?  showDirectoryTree,TResult? Function( RemoveDirectoryTree value)?  removeDirectoryTree,TResult? Function( SelectNode value)?  selectNode,TResult? Function( ClearNodeSelection value)?  clearNodeSelection,TResult? Function( SaveNodeAsSnippet value)?  saveNodeAsSnippet,TResult? Function( ReplaceSelectionWith value)?  replaceSelectionWith,TResult? Function( WrapSelectionWith value)?  wrapSelectionWith,TResult? Function( AppendChild value)?  appendChild,TResult? Function( PrependArticle value)?  prependArticle,TResult? Function( AddSiblingBefore value)?  addSiblingBefore,TResult? Function( AddSiblingAfter value)?  addSiblingAfter,TResult? Function( PasteReplacement value)?  pasteReplacement,TResult? Function( PasteChild value)?  pasteChild,TResult? Function( PasteSiblingBefore value)?  pasteSiblingBefore,TResult? Function( PasteSiblingAfter value)?  pasteSiblingAfter,TResult? Function( DeleteNodeTapped value)?  deleteNodeTapped,TResult? Function( DeleteArticle value)?  deleteArticle,TResult? Function( CompleteDeletion value)?  completeDeletion,TResult? Function( CopySnippetJsonToClipboard value)?  copySnippetJsonToClipboard,TResult? Function( ReplaceSnippetFromJson value)?  replaceSnippetFromJson,TResult? Function( CopyNode value)?  copyNode,TResult? Function( CutNode value)?  cutNode,TResult? Function( SelectedDirectoryOrNode value)?  selectedDirectoryOrNode,TResult? Function( ImageChanged value)?  imageChanged,TResult? Function( Undo value)?  undo,TResult? Function( Redo value)?  redo,TResult? Function( ForceSnippetRefresh value)?  forceSnippetRefresh,}){
final _that = this;
switch (_that) {
case SignedInAsSuperEditor() when signedInAsSuperEditor != null:
return signedInAsSuperEditor(_that);case SignedInAsArticleEditor() when signedInAsArticleEditor != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  signedInAsSuperEditor,TResult Function()?  signedInAsArticleEditor,TResult Function()?  signedInAsGuestEditor,TResult Function()?  signedOut,TResult Function( String wName,  int index,  GlobalKey gk)?  overrideTargetGK,TResult Function( bool onlyTargetsWrappers)?  forceRefresh,TResult Function( SnippetName? snippetName)?  toggleSnippetVisibility,TResult Function()?  clearClipboard,TResult Function( SnippetName snippetName,  VersionId versionId)?  publishSnippet,TResult Function( SnippetName snippetName,  VersionId versionId)?  revertSnippet,TResult Function( String pathName)?  deletePage,TResult Function( SnippetName snippetName)?  toggleAutoPublishingOfSnippet,TResult Function( bool b)?  autoPublishDefault,TResult Function( SnippetName snippetName,  PanelName panelName)?  setPanelOrPlaceholderSnippet,TResult Function( SnippetName snippetName)?  enterNodeSelectionMode,TResult Function()?  updateTappableRects,TResult Function()?  exitNodeSelectionMode,TResult Function( SNode rootNode,  SNode? selectedNode)?  pushSnippetEditor,TResult Function()?  changedSnippet,TResult Function( bool save)?  popSnippetEditor,TResult Function()?  showDirectoryTree,TResult Function( bool save)?  removeDirectoryTree,TResult Function( SNode node)?  selectNode,TResult Function()?  clearNodeSelection,TResult Function( SNode node,  String newSnippetName)?  saveNodeAsSnippet,TResult Function( Type? type,  SNode? testNode)?  replaceSelectionWith,TResult Function( Type? type,  SNode? testNode)?  wrapSelectionWith,TResult Function( Type? type,  SNode? testNode)?  appendChild,TResult Function( ArticleListViewNode listNode,  Type? type,  SNode? testNode)?  prependArticle,TResult Function( Type? type,  SNode? testNode)?  addSiblingBefore,TResult Function( Type? type,  SNode? testNode)?  addSiblingAfter,TResult Function()?  pasteReplacement,TResult Function()?  pasteChild,TResult Function()?  pasteSiblingBefore,TResult Function()?  pasteSiblingAfter,TResult Function()?  deleteNodeTapped,TResult Function( SNode articleSnippet)?  deleteArticle,TResult Function()?  completeDeletion,TResult Function( SNode rootNode)?  copySnippetJsonToClipboard,TResult Function( String snippetBeingReplaced,  String? snippetJson)?  replaceSnippetFromJson,TResult Function( SNode node)?  copyNode,TResult Function( SNode node)?  cutNode,TResult Function( SnippetName snippetName,  SNode? selectedNode)?  selectedDirectoryOrNode,TResult Function( Uint8List? newBytes)?  imageChanged,TResult Function()?  undo,TResult Function()?  redo,TResult Function()?  forceSnippetRefresh,required TResult orElse(),}) {final _that = this;
switch (_that) {
case SignedInAsSuperEditor() when signedInAsSuperEditor != null:
return signedInAsSuperEditor();case SignedInAsArticleEditor() when signedInAsArticleEditor != null:
return signedInAsArticleEditor();case SignedInAsGuestEditor() when signedInAsGuestEditor != null:
return signedInAsGuestEditor();case SignedOut() when signedOut != null:
...
return toggleSnippetVisibility(_that.snippetName);case ClearClipboard() when clearClipboard != null:
return clearClipboard();case PublishSnippet() when publishSnippet != null:
...
return setPanelOrPlaceholderSnippet(_that.snippetName,_that.panelName);case EnterSelectWidgetMode() when enterNodeSelectionMode != null:
return enterNodeSelectionMode(_that.snippetName);case UpdateTappableRects() when updateTappableRects != null:
return updateTappableRects();case ExitSelectWidgetMode() when exitNodeSelectionMode != null:
return exitNodeSelectionMode();case PushSnippetEditor() when pushSnippetEditor != null:
return pushSnippetEditor(_that.rootNode,_that.selectedNode);case ChangedSnippet() when changedSnippet != null:
return changedSnippet();case PopSnippetEditor() when popSnippetEditor != null:
...
return replaceSelectionWith(_that.type,_that.testNode);case WrapSelectionWith() when wrapSelectionWith != null:
return wrapSelectionWith(_that.type,_that.testNode);case AppendChild() when appendChild != null:
return appendChild(_that.type,_that.testNode);case PrependArticle() when prependArticle != null:
return prependArticle(_that.listNode,_that.type,_that.testNode);case AddSiblingBefore() when addSiblingBefore != null:
return addSiblingBefore(_that.type,_that.testNode);case AddSiblingAfter() when addSiblingAfter != null:
return addSiblingAfter(_that.type,_that.testNode);case PasteReplacement() when pasteReplacement != null:
return pasteReplacement();case PasteChild() when pasteChild != null:
return pasteChild();case PasteSiblingBefore() when pasteSiblingBefore != null:
...
return deleteNodeTapped();case DeleteArticle() when deleteArticle != null:
return deleteArticle(_that.articleSnippet);case CompleteDeletion() when completeDeletion != null:
...
return replaceSnippetFromJson(_that.snippetBeingReplaced,_that.snippetJson);case CopyNode() when copyNode != null:
return copyNode(_that.node);case CutNode() when cutNode != null:
return cutNode(_that.node);case SelectedDirectoryOrNode() when selectedDirectoryOrNode != null:
return selectedDirectoryOrNode(_that.snippetName,_that.selectedNode);case ImageChanged() when imageChanged != null:
return imageChanged(_that.newBytes);case Undo() when undo != null:
return undo();case Redo() when redo != null:
return redo();case ForceSnippetRefresh() when forceSnippetRefresh != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  signedInAsSuperEditor,required TResult Function()  signedInAsArticleEditor,required TResult Function()  signedInAsGuestEditor,required TResult Function()  signedOut,required TResult Function( String wName,  int index,  GlobalKey gk)  overrideTargetGK,required TResult Function( bool onlyTargetsWrappers)  forceRefresh,required TResult Function( SnippetName? snippetName)  toggleSnippetVisibility,required TResult Function()  clearClipboard,required TResult Function( SnippetName snippetName,  VersionId versionId)  publishSnippet,required TResult Function( SnippetName snippetName,  VersionId versionId)  revertSnippet,required TResult Function( String pathName)  deletePage,required TResult Function( SnippetName snippetName)  toggleAutoPublishingOfSnippet,required TResult Function( bool b)  autoPublishDefault,required TResult Function( SnippetName snippetName,  PanelName panelName)  setPanelOrPlaceholderSnippet,required TResult Function( SnippetName snippetName)  enterNodeSelectionMode,required TResult Function()  updateTappableRects,required TResult Function()  exitNodeSelectionMode,required TResult Function( SNode rootNode,  SNode? selectedNode)  pushSnippetEditor,required TResult Function()  changedSnippet,required TResult Function( bool save)  popSnippetEditor,required TResult Function()  showDirectoryTree,required TResult Function( bool save)  removeDirectoryTree,required TResult Function( SNode node)  selectNode,required TResult Function()  clearNodeSelection,required TResult Function( SNode node,  String newSnippetName)  saveNodeAsSnippet,required TResult Function( Type? type,  SNode? testNode)  replaceSelectionWith,required TResult Function( Type? type,  SNode? testNode)  wrapSelectionWith,required TResult Function( Type? type,  SNode? testNode)  appendChild,required TResult Function( ArticleListViewNode listNode,  Type? type,  SNode? testNode)  prependArticle,required TResult Function( Type? type,  SNode? testNode)  addSiblingBefore,required TResult Function( Type? type,  SNode? testNode)  addSiblingAfter,required TResult Function()  pasteReplacement,required TResult Function()  pasteChild,required TResult Function()  pasteSiblingBefore,required TResult Function()  pasteSiblingAfter,required TResult Function()  deleteNodeTapped,required TResult Function( SNode articleSnippet)  deleteArticle,required TResult Function()  completeDeletion,required TResult Function( SNode rootNode)  copySnippetJsonToClipboard,required TResult Function( String snippetBeingReplaced,  String? snippetJson)  replaceSnippetFromJson,required TResult Function( SNode node)  copyNode,required TResult Function( SNode node)  cutNode,required TResult Function( SnippetName snippetName,  SNode? selectedNode)  selectedDirectoryOrNode,required TResult Function( Uint8List? newBytes)  imageChanged,required TResult Function()  undo,required TResult Function()  redo,required TResult Function()  forceSnippetRefresh,}) {final _that = this;
switch (_that) {
case SignedInAsSuperEditor():
return signedInAsSuperEditor();case SignedInAsArticleEditor():
return signedInAsArticleEditor();case SignedInAsGuestEditor():
return signedInAsGuestEditor();case SignedOut():
...
return toggleSnippetVisibility(_that.snippetName);case ClearClipboard():
return clearClipboard();case PublishSnippet():
...
return enterNodeSelectionMode(_that.snippetName);case UpdateTappableRects():
return updateTappableRects();case ExitSelectWidgetMode():
return exitNodeSelectionMode();case PushSnippetEditor():
return pushSnippetEditor(_that.rootNode,_that.selectedNode);case ChangedSnippet():
return changedSnippet();case PopSnippetEditor():
...
return replaceSelectionWith(_that.type,_that.testNode);case WrapSelectionWith():
return wrapSelectionWith(_that.type,_that.testNode);case AppendChild():
return appendChild(_that.type,_that.testNode);case PrependArticle():
return prependArticle(_that.listNode,_that.type,_that.testNode);case AddSiblingBefore():
return addSiblingBefore(_that.type,_that.testNode);case AddSiblingAfter():
return addSiblingAfter(_that.type,_that.testNode);case PasteReplacement():
return pasteReplacement();case PasteChild():
return pasteChild();case PasteSiblingBefore():
return pasteSiblingBefore();case PasteSiblingAfter():
return pasteSiblingAfter();case DeleteNodeTapped():
return deleteNodeTapped();case DeleteArticle():
return deleteArticle(_that.articleSnippet);case CompleteDeletion():
...
return replaceSnippetFromJson(_that.snippetBeingReplaced,_that.snippetJson);case CopyNode():
return copyNode(_that.node);case CutNode():
return cutNode(_that.node);case SelectedDirectoryOrNode():
return selectedDirectoryOrNode(_that.snippetName,_that.selectedNode);case ImageChanged():
return imageChanged(_that.newBytes);case Undo():
return undo();case Redo():
return redo();case ForceSnippetRefresh():
return forceSnippetRefresh();case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  signedInAsSuperEditor,TResult? Function()?  signedInAsArticleEditor,TResult? Function()?  signedInAsGuestEditor,TResult? Function()?  signedOut,TResult? Function( String wName,  int index,  GlobalKey gk)?  overrideTargetGK,TResult? Function( bool onlyTargetsWrappers)?  forceRefresh,TResult? Function( SnippetName? snippetName)?  toggleSnippetVisibility,TResult? Function()?  clearClipboard,TResult? Function( SnippetName snippetName,  VersionId versionId)?  publishSnippet,TResult? Function( SnippetName snippetName,  VersionId versionId)?  revertSnippet,TResult? Function( String pathName)?  deletePage,TResult? Function( SnippetName snippetName)?  toggleAutoPublishingOfSnippet,TResult? Function( bool b)?  autoPublishDefault,TResult? Function( SnippetName snippetName,  PanelName panelName)?  setPanelOrPlaceholderSnippet,TResult? Function( SnippetName snippetName)?  enterNodeSelectionMode,TResult? Function()?  updateTappableRects,TResult? Function()?  exitNodeSelectionMode,TResult? Function( SNode rootNode,  SNode? selectedNode)?  pushSnippetEditor,TResult? Function()?  changedSnippet,TResult? Function( bool save)?  popSnippetEditor,TResult? Function()?  showDirectoryTree,TResult? Function( bool save)?  removeDirectoryTree,TResult? Function( SNode node)?  selectNode,TResult? Function()?  clearNodeSelection,TResult? Function( SNode node,  String newSnippetName)?  saveNodeAsSnippet,TResult? Function( Type? type,  SNode? testNode)?  replaceSelectionWith,TResult? Function( Type? type,  SNode? testNode)?  wrapSelectionWith,TResult? Function( Type? type,  SNode? testNode)?  appendChild,TResult? Function( ArticleListViewNode listNode,  Type? type,  SNode? testNode)?  prependArticle,TResult? Function( Type? type,  SNode? testNode)?  addSiblingBefore,TResult? Function( Type? type,  SNode? testNode)?  addSiblingAfter,TResult? Function()?  pasteReplacement,TResult? Function()?  pasteChild,TResult? Function()?  pasteSiblingBefore,TResult? Function()?  pasteSiblingAfter,TResult? Function()?  deleteNodeTapped,TResult? Function( SNode articleSnippet)?  deleteArticle,TResult? Function()?  completeDeletion,TResult? Function( SNode rootNode)?  copySnippetJsonToClipboard,TResult? Function( String snippetBeingReplaced,  String? snippetJson)?  replaceSnippetFromJson,TResult? Function( SNode node)?  copyNode,TResult? Function( SNode node)?  cutNode,TResult? Function( SnippetName snippetName,  SNode? selectedNode)?  selectedDirectoryOrNode,TResult? Function( Uint8List? newBytes)?  imageChanged,TResult? Function()?  undo,TResult? Function()?  redo,TResult? Function()?  forceSnippetRefresh,}) {final _that = this;
switch (_that) {
case SignedInAsSuperEditor() when signedInAsSuperEditor != null:
return signedInAsSuperEditor();case SignedInAsArticleEditor() when signedInAsArticleEditor != null:
return signedInAsArticleEditor();case SignedInAsGuestEditor() when signedInAsGuestEditor != null:
...
class SignedInAsSuperEditor extends CAPIEvent with DiagnosticableTreeMixin {
  const SignedInAsSuperEditor(): super._();
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'CAPIEvent.signedInAsSuperEditor'))
    ;
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SignedInAsSuperEditor);
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.signedInAsSuperEditor()';
}
...
class SignedInAsArticleEditor extends CAPIEvent with DiagnosticableTreeMixin {
  const SignedInAsArticleEditor(): super._();
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'CAPIEvent.signedInAsArticleEditor'))
    ;
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SignedInAsArticleEditor);
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.signedInAsArticleEditor()';
}
...
class SignedInAsGuestEditor extends CAPIEvent with DiagnosticableTreeMixin {
  const SignedInAsGuestEditor(): super._();
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'CAPIEvent.signedInAsGuestEditor'))
    ;
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SignedInAsGuestEditor);
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.signedInAsGuestEditor()';
}
...
class ClearClipboard extends CAPIEvent with DiagnosticableTreeMixin {
  const ClearClipboard(): super._();
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'CAPIEvent.clearClipboard'))
    ;
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ClearClipboard);
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.clearClipboard()';
}
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'CAPIEvent.enterNodeSelectionMode'))
    ..add(DiagnosticsProperty('snippetName', snippetName));
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.enterNodeSelectionMode(snippetName: $snippetName)';
}
...
class UpdateTappableRects extends CAPIEvent with DiagnosticableTreeMixin {
  const UpdateTappableRects(): super._();
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'CAPIEvent.updateTappableRects'))
    ;
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateTappableRects);
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.updateTappableRects()';
}
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'CAPIEvent.exitNodeSelectionMode'))
    ;
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.exitNodeSelectionMode()';
}
...
@useResult
$Res call({
 SNode rootNode, SNode? selectedNode
});
...
as SNode,selectedNode: freezed == selectedNode ? _self.selectedNode : selectedNode // ignore: cast_nullable_to_non_nullable
as SNode?,
  ));
}
...
class ChangedSnippet extends CAPIEvent with DiagnosticableTreeMixin {
  const ChangedSnippet(): super._();
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'CAPIEvent.changedSnippet'))
    ;
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChangedSnippet);
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.changedSnippet()';
}
...
class ReplaceSelectionWith extends CAPIEvent with DiagnosticableTreeMixin {
  const ReplaceSelectionWith({this.type, this.testNode}): super._();
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('type', type))..add(DiagnosticsProperty('testNode', testNode));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReplaceSelectionWith&&(identical(other.type, type) || other.type == type)&&(identical(other.testNode, testNode) || other.testNode == testNode));
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.replaceSelectionWith(type: $type, testNode: $testNode)';
}
...
/// Create a copy of CAPIEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? type = freezed,Object? testNode = freezed,}) {
...
class WrapSelectionWith extends CAPIEvent with DiagnosticableTreeMixin {
  const WrapSelectionWith({this.type, this.testNode}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WrapSelectionWith&&(identical(other.type, type) || other.type == type)&&(identical(other.testNode, testNode) || other.testNode == testNode));
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.wrapSelectionWith(type: $type, testNode: $testNode)';
}
...
class AppendChild extends CAPIEvent with DiagnosticableTreeMixin {
  const AppendChild({this.type, this.testNode}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppendChild&&(identical(other.type, type) || other.type == type)&&(identical(other.testNode, testNode) || other.testNode == testNode));
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.appendChild(type: $type, testNode: $testNode)';
}
...
class PrependArticle extends CAPIEvent with DiagnosticableTreeMixin {
  const PrependArticle({required this.listNode, this.type, this.testNode}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$PrependArticleCopyWith<PrependArticle> get copyWith => _$PrependArticleCopyWithImpl<PrependArticle>(this, _$identity);


@override
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'CAPIEvent.prependArticle'))
    ..add(DiagnosticsProperty('listNode', listNode))..add(DiagnosticsProperty('type', type))..add(DiagnosticsProperty('testNode', testNode));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PrependArticle&&(identical(other.listNode, listNode) || other.listNode == listNode)&&(identical(other.type, type) || other.type == type)&&(identical(other.testNode, testNode) || other.testNode == testNode));
}


@override
int get hashCode => Object.hash(runtimeType,listNode,type,testNode);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.prependArticle(listNode: $listNode, type: $type, testNode: $testNode)';
}
...
/// @nodoc
abstract mixin class $PrependArticleCopyWith<$Res> implements $CAPIEventCopyWith<$Res> {
  factory $PrependArticleCopyWith(PrependArticle value, $Res Function(PrependArticle) _then) = _$PrependArticleCopyWithImpl;
@useResult
$Res call({
 ArticleListViewNode listNode, Type? type, SNode? testNode
});
...
/// @nodoc
class _$PrependArticleCopyWithImpl<$Res>
    implements $PrependArticleCopyWith<$Res> {
  _$PrependArticleCopyWithImpl(this._self, this._then);

  final PrependArticle _self;
  final $Res Function(PrependArticle) _then;

/// Create a copy of CAPIEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? listNode = null,Object? type = freezed,Object? testNode = freezed,}) {
  return _then(PrependArticle(
listNode: null == listNode ? _self.listNode : listNode // ignore: cast_nullable_to_non_nullable
as ArticleListViewNode,type: freezed == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as Type?,testNode: freezed == testNode ? _self.testNode : testNode // ignore: cast_nullable_to_non_nullable
as SNode?,
  ));
}
...
class AddSiblingBefore extends CAPIEvent with DiagnosticableTreeMixin {
  const AddSiblingBefore({this.type, this.testNode}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AddSiblingBefore&&(identical(other.type, type) || other.type == type)&&(identical(other.testNode, testNode) || other.testNode == testNode));
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.addSiblingBefore(type: $type, testNode: $testNode)';
}
...
class AddSiblingAfter extends CAPIEvent with DiagnosticableTreeMixin {
  const AddSiblingAfter({this.type, this.testNode}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AddSiblingAfter&&(identical(other.type, type) || other.type == type)&&(identical(other.testNode, testNode) || other.testNode == testNode));
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.addSiblingAfter(type: $type, testNode: $testNode)';
}
...
class PasteReplacement extends CAPIEvent with DiagnosticableTreeMixin {
  const PasteReplacement(): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PasteReplacement);
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.pasteReplacement()';
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PasteChild);
}
...
class DeleteArticle extends CAPIEvent with DiagnosticableTreeMixin {
  const DeleteArticle({required this.articleSnippet}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$DeleteArticleCopyWith<DeleteArticle> get copyWith => _$DeleteArticleCopyWithImpl<DeleteArticle>(this, _$identity);


@override
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'CAPIEvent.deleteArticle'))
    ..add(DiagnosticsProperty('articleSnippet', articleSnippet));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeleteArticle&&(identical(other.articleSnippet, articleSnippet) || other.articleSnippet == articleSnippet));
}


@override
int get hashCode => Object.hash(runtimeType,articleSnippet);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.deleteArticle(articleSnippet: $articleSnippet)';
}
...
/// @nodoc
abstract mixin class $DeleteArticleCopyWith<$Res> implements $CAPIEventCopyWith<$Res> {
  factory $DeleteArticleCopyWith(DeleteArticle value, $Res Function(DeleteArticle) _then) = _$DeleteArticleCopyWithImpl;
@useResult
$Res call({
 SNode articleSnippet
});
...
/// @nodoc
class _$DeleteArticleCopyWithImpl<$Res>
    implements $DeleteArticleCopyWith<$Res> {
  _$DeleteArticleCopyWithImpl(this._self, this._then);

  final DeleteArticle _self;
  final $Res Function(DeleteArticle) _then;

/// Create a copy of CAPIEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? articleSnippet = null,}) {
  return _then(DeleteArticle(
articleSnippet: null == articleSnippet ? _self.articleSnippet : articleSnippet // ignore: cast_nullable_to_non_nullable
as SNode,
  ));
}
...
class ReplaceSnippetFromJson extends CAPIEvent with DiagnosticableTreeMixin {
  const ReplaceSnippetFromJson({required this.snippetBeingReplaced, required this.snippetJson}): super._();
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('snippetBeingReplaced', snippetBeingReplaced))..add(DiagnosticsProperty('snippetJson', snippetJson));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReplaceSnippetFromJson&&(identical(other.snippetBeingReplaced, snippetBeingReplaced) || other.snippetBeingReplaced == snippetBeingReplaced)&&(identical(other.snippetJson, snippetJson) || other.snippetJson == snippetJson));
}


@override
int get hashCode => Object.hash(runtimeType,snippetBeingReplaced,snippetJson);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.replaceSnippetFromJson(snippetBeingReplaced: $snippetBeingReplaced, snippetJson: $snippetJson)';
}
...
@useResult
$Res call({
 String snippetBeingReplaced, String? snippetJson
});
...
/// Create a copy of CAPIEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? snippetBeingReplaced = null,Object? snippetJson = freezed,}) {
  return _then(ReplaceSnippetFromJson(
snippetBeingReplaced: null == snippetBeingReplaced ? _self.snippetBeingReplaced : snippetBeingReplaced // ignore: cast_nullable_to_non_nullable
as String,snippetJson: freezed == snippetJson ? _self.snippetJson : snippetJson // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
class CopyNode extends CAPIEvent with DiagnosticableTreeMixin {
  const CopyNode({required this.node}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CopyNode&&(identical(other.node, node) || other.node == node));
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.copyNode(node: $node)';
}
...
class CutNode extends CAPIEvent with DiagnosticableTreeMixin {
  const CutNode({required this.node}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CutNode&&(identical(other.node, node) || other.node == node));
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'CAPIEvent.cutNode(node: $node)';
}
...
class Undo extends CAPIEvent with DiagnosticableTreeMixin {
  const Undo(): super._();
...
class Redo extends CAPIEvent with DiagnosticableTreeMixin {
  const Redo(): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Redo);
}
