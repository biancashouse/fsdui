...
class TabBarViewNodeMapper extends SubClassMapperBase<TabBarViewNode> {
  ...
  static const Field<TabBarViewNode, String> _f$name = Field(
    'name',
    _$name,
    opt: true,
  );
  ...
  static bool? _$enableSwipe(TabBarViewNode v) => v.enableSwipe;
  static const Field<TabBarViewNode, bool> _f$enableSwipe = Field(
    'enableSwipe',
    _$enableSwipe,
    opt: true,
  );
  ...
  static const Field<TabBarViewNode, String> _f$uid = Field(
    'uid',
    _$uid,
    mode: FieldMode.member,
  );
  static List<String>? _$tags(TabBarViewNode v) => v.tags;
  static const Field<TabBarViewNode, List<String>> _f$tags = Field(
    'tags',
    _$tags,
    mode: FieldMode.member,
  );
  ...
  static const Field<TabBarViewNode, bool> _f$isExpanded = Field(
    'isExpanded',
    _$isExpanded,
    mode: FieldMode.member,
  );
  ...
  static GlobalKey<State<StatefulWidget>>? _$nodeGK(TabBarViewNode v) =>
      v.nodeGK;
  static const Field<TabBarViewNode, GlobalKey<State<StatefulWidget>>>
  ...
  static TabBarViewNode _instantiate(DecodingData data) {
    return TabBarViewNode(
      ...
      enableSwipe: data.dec(_f$enableSwipe),
...
mixin TabBarViewNodeMappable {
  String toJson() {
    return TabBarViewNodeMapper.ensureInitialized().encodeJson<TabBarViewNode>(
      this as TabBarViewNode,
    );
  }

  Map<String, dynamic> toMap() {
    return TabBarViewNodeMapper.ensureInitialized().encodeMap<TabBarViewNode>(
      this as TabBarViewNode,
    );
  }

  TabBarViewNodeCopyWith<TabBarViewNode, TabBarViewNode, TabBarViewNode>
  get copyWith => _TabBarViewNodeCopyWithImpl<TabBarViewNode, TabBarViewNode>(
    this as TabBarViewNode,
    $identity,
    $identity,
  );
  @override
  String toString() {
    return TabBarViewNodeMapper.ensureInitialized().stringifyValue(
      this as TabBarViewNode,
    );
  }
  ...
  bool operator ==(Object other) {
    return TabBarViewNodeMapper.ensureInitialized().equalsValue(
      this as TabBarViewNode,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return TabBarViewNodeMapper.ensureInitialized().hashValue(
      this as TabBarViewNode,
    );
  }
}
...
class _TabBarViewNodeCopyWithImpl<$R, $Out>
  ...
  $R call({
    ...
    Object? enableSwipe = $none,
    List<SNode>? children,
  }) => $apply(
    FieldCopyWithData({
      if (name != $none) #name: name,
      if (tabBarName != $none) #tabBarName: tabBarName,
      if (enableSwipe != $none) #enableSwipe: enableSwipe,
  ...
  TabBarViewNode $make(CopyWithData data) => TabBarViewNode(
    ...
    enableSwipe: data.get(#enableSwipe, or: $value.enableSwipe),
