...
class TabBarNodeMapper extends SubClassMapperBase<TabBarNode> {
  ...
  static const Field<TabBarNode, String> _f$name =
      Field('name', _$name, opt: true);
  static Color? _$bgColor(TabBarNode v) => v.bgColor;
  static const Field<TabBarNode, Color> _f$bgColor =
  ...
  static const Field<TabBarNode, Color> _f$selectedLabelColor =
  ...
  static const Field<TabBarNode, List<String>> _f$tags =
  ...
  static const Field<TabBarNode, ValueNotifier<TabController?>>
      _f$tabCNotifier =
      Field('tabCNotifier', _$tabCNotifier, mode: FieldMode.member);
