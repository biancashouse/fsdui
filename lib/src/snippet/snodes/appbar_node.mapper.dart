...
class AppBarNodeMapper extends SubClassMapperBase<AppBarNode> {
  ...
  static const Field<AppBarNode, String> _f$name =
      Field('name', _$name, opt: true);
  static Color? _$bgColor(AppBarNode v) => v.bgColor;
  static const Field<AppBarNode, Color> _f$bgColor =
      Field('bgColor', _$bgColor, opt: true);
  static Color? _$fgColor(AppBarNode v) => v.fgColor;
  static const Field<AppBarNode, Color> _f$fgColor =
  ...
  static const Field<AppBarNode, NamedMC> _f$actions =
      Field('actions', _$actions);
  static Color? _$shadowColor(AppBarNode v) => v.shadowColor;
  static const Field<AppBarNode, Color> _f$shadowColor =
      Field('shadowColor', _$shadowColor, opt: true);
  static double? _$scrolledUnderElevation(AppBarNode v) =>
      v.scrolledUnderElevation;
  static const Field<AppBarNode, double> _f$scrolledUnderElevation =
  ...
  static const Field<AppBarNode, List<String>> _f$tags =
