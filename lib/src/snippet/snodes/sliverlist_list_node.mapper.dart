...
class SliverListListNodeMapper extends SubClassMapperBase<SliverListListNode> {
  ...
  static const Field<SliverListListNode, String> _f$name =
      Field('name', _$name, opt: true);
  static List<SNode> _$children(SliverListListNode v) => v.children;
  static const Field<SliverListListNode, List<SNode>> _f$children =
      Field('children', _$children);
  static String _$uid(SliverListListNode v) => v.uid;
  static const Field<SliverListListNode, String> _f$uid =
      Field('uid', _$uid, mode: FieldMode.member);
  static List<String>? _$tags(SliverListListNode v) => v.tags;
  static const Field<SliverListListNode, List<String>> _f$tags =
  ...
  static const Field<SliverListListNode, bool> _f$isExpanded =
  ...
  static GlobalKey<State<StatefulWidget>>? _$nodeGK(SliverListListNode v) =>
      v.nodeGK;
  static const Field<SliverListListNode, GlobalKey<State<StatefulWidget>>>
...
mixin SliverListListNodeMappable {
  ...
  SliverListListNodeCopyWith<SliverListListNode, SliverListListNode,
          SliverListListNode>
      get copyWith => _SliverListListNodeCopyWithImpl<SliverListListNode,
          SliverListListNode>(this as SliverListListNode, $identity, $identity);
  @override
  String toString() {
    return SliverListListNodeMapper.ensureInitialized()
        .stringifyValue(this as SliverListListNode);
  }

  @override
  bool operator ==(Object other) {
    return SliverListListNodeMapper.ensureInitialized()
        .equalsValue(this as SliverListListNode, other);
  }

  @override
  int get hashCode {
    return SliverListListNodeMapper.ensureInitialized()
        .hashValue(this as SliverListListNode);
  }
}
...
abstract class SliverListListNodeCopyWith<$R, $In extends SliverListListNode,
