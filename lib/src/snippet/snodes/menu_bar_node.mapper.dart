...
class MenuBarNodeMapper extends SubClassMapperBase<MenuBarNode> {
  ...
  static GlobalKey<State<StatefulWidget>>? _$gk(MenuBarNode v) => v.gk;
  static const Field<MenuBarNode, GlobalKey<State<StatefulWidget>>> _f$gk =
...
mixin MenuBarNodeMappable {
  ...
  bool operator ==(Object other) {
    return MenuBarNodeMapper.ensureInitialized()
        .equalsValue(this as MenuBarNode, other);
  }
