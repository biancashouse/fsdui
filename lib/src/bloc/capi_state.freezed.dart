...
// String? selectedPanel,
 String? get verifiedEa; bool get isSignedInAsSuperEditor; bool get isSignedInAsArticleEditor; bool get isSignedInAsGuestEditor; bool get showClipboardContent; int get force;// hacky way to force a transition
...
@useResult
$Res call({
 HotspotTargetModel? newestTarget, HotspotTargetModel? selectedTarget, String? verifiedEa, bool isSignedInAsSuperEditor, bool isSignedInAsArticleEditor, bool isSignedInAsGuestEditor, bool showClipboardContent, int force, bool onlyTargetsWrappers, String? routeName, SnippetName? activeSnippetName, SnippetBeingEdited? snippetBeingEdited, bool ONLY_TESTING
});
...
/// Create a copy of CAPIState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? newestTarget = freezed,Object? selectedTarget = freezed,Object? verifiedEa = freezed,Object? isSignedInAsSuperEditor = null,Object? isSignedInAsArticleEditor = null,Object? isSignedInAsGuestEditor = null,Object? showClipboardContent = null,Object? force = null,Object? onlyTargetsWrappers = null,Object? routeName = freezed,Object? activeSnippetName = freezed,Object? snippetBeingEdited = freezed,Object? ONLY_TESTING = null,}) {
...
as HotspotTargetModel?,verifiedEa: freezed == verifiedEa ? _self.verifiedEa : verifiedEa // ignore: cast_nullable_to_non_nullable
as String?,isSignedInAsSuperEditor: null == isSignedInAsSuperEditor ? _self.isSignedInAsSuperEditor : isSignedInAsSuperEditor // ignore: cast_nullable_to_non_nullable
as bool,isSignedInAsArticleEditor: null == isSignedInAsArticleEditor ? _self.isSignedInAsArticleEditor : isSignedInAsArticleEditor // ignore: cast_nullable_to_non_nullable
as bool,isSignedInAsGuestEditor: null == isSignedInAsGuestEditor ? _self.isSignedInAsGuestEditor : isSignedInAsGuestEditor // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( HotspotTargetModel? newestTarget,  HotspotTargetModel? selectedTarget,  String? verifiedEa,  bool isSignedInAsSuperEditor,  bool isSignedInAsArticleEditor,  bool isSignedInAsGuestEditor,  bool showClipboardContent,  int force,  bool onlyTargetsWrappers,  String? routeName,  SnippetName? activeSnippetName,  SnippetBeingEdited? snippetBeingEdited,  bool ONLY_TESTING)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CAPIState() when $default != null:
return $default(_that.newestTarget,_that.selectedTarget,_that.verifiedEa,_that.isSignedInAsSuperEditor,_that.isSignedInAsArticleEditor,_that.isSignedInAsGuestEditor,_that.showClipboardContent,_that.force,_that.onlyTargetsWrappers,_that.routeName,_that.activeSnippetName,_that.snippetBeingEdited,_that.ONLY_TESTING);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( HotspotTargetModel? newestTarget,  HotspotTargetModel? selectedTarget,  String? verifiedEa,  bool isSignedInAsSuperEditor,  bool isSignedInAsArticleEditor,  bool isSignedInAsGuestEditor,  bool showClipboardContent,  int force,  bool onlyTargetsWrappers,  String? routeName,  SnippetName? activeSnippetName,  SnippetBeingEdited? snippetBeingEdited,  bool ONLY_TESTING)  $default,) {final _that = this;
switch (_that) {
case _CAPIState():
return $default(_that.newestTarget,_that.selectedTarget,_that.verifiedEa,_that.isSignedInAsSuperEditor,_that.isSignedInAsArticleEditor,_that.isSignedInAsGuestEditor,_that.showClipboardContent,_that.force,_that.onlyTargetsWrappers,_that.routeName,_that.activeSnippetName,_that.snippetBeingEdited,_that.ONLY_TESTING);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( HotspotTargetModel? newestTarget,  HotspotTargetModel? selectedTarget,  String? verifiedEa,  bool isSignedInAsSuperEditor,  bool isSignedInAsArticleEditor,  bool isSignedInAsGuestEditor,  bool showClipboardContent,  int force,  bool onlyTargetsWrappers,  String? routeName,  SnippetName? activeSnippetName,  SnippetBeingEdited? snippetBeingEdited,  bool ONLY_TESTING)?  $default,) {final _that = this;
switch (_that) {
case _CAPIState() when $default != null:
return $default(_that.newestTarget,_that.selectedTarget,_that.verifiedEa,_that.isSignedInAsSuperEditor,_that.isSignedInAsArticleEditor,_that.isSignedInAsGuestEditor,_that.showClipboardContent,_that.force,_that.onlyTargetsWrappers,_that.routeName,_that.activeSnippetName,_that.snippetBeingEdited,_that.ONLY_TESTING);case _:
  return null;
...
class _CAPIState implements CAPIState {
   _CAPIState({this.newestTarget, this.selectedTarget, this.verifiedEa, this.isSignedInAsSuperEditor = false, this.isSignedInAsArticleEditor = false, this.isSignedInAsGuestEditor = false, this.showClipboardContent = true, this.force = 0, this.onlyTargetsWrappers = false, this.routeName, this.activeSnippetName, this.snippetBeingEdited, this.ONLY_TESTING = true});
...
//
// String? selectedPanel,
@override final  String? verifiedEa;
@override@JsonKey() final  bool isSignedInAsSuperEditor;
@override@JsonKey() final  bool isSignedInAsArticleEditor;
@override@JsonKey() final  bool isSignedInAsGuestEditor;
