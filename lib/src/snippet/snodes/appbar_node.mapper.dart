...
class AppBarNodeMapper extends SubClassMapperBase<AppBarNode> {
  ...
  static const Field<AppBarNode, Color> _f$bgColor = Field(
    'bgColor',
    _$bgColor,
    opt: true,
  );
  static Color? _$fgColor(AppBarNode v) => v.fgColor;
  static const Field<AppBarNode, Color> _f$fgColor = Field(
    'fgColor',
    _$fgColor,
    opt: true,
  );
  ...
  static const Field<AppBarNode, Color> _f$shadowColor = Field(
    'shadowColor',
    _$shadowColor,
    opt: true,
  );
