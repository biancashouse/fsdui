...
class PathUtil {
  static const DEFAULT_THICKNESS = 10.0;
  ...
  static void roundedRectCentred(
    Path path,
    double x,
    double y,
    double width,
  ...
  static Coord trCorner(Path path, double x, double y, double r, bool skipArc) {
    if (skipArc) {
      path
        ..moveTo(x, y)
        ..moveTo(x + r, y + r);
  ...
  static Coord tlCorner(Path path, double x, double y, double r, bool skipArc) {
    if (skipArc) {
      path
        ..moveTo(x, y)
        ..moveTo(x + r, y - r);
  ...
  static Coord blCorner(Path path, double x, double y, double r, bool skipArc) {
    if (skipArc) {
      path
        ..moveTo(x, y)
        ..moveTo(x - r, y - r);
  ...
  static Coord brCorner(Path path, double x, double y, double r, bool skipArc) {
    if (skipArc) {
      path
        ..moveTo(x, y)
        ..moveTo(x - r, y + r);
  ...
  /*
	 ...
	 */
  static Coord turnCornerClockwise(
    Path path,
    Coord thePos,
    Rectangle theRect,
    double theRadius,
  ...
  static Coord lineToStartOfNextCorner(
    Path path,
    Coord thePos,
    Rectangle theRect,
    double theRadius, {
