...
// //
// //     Rect screenRect = Rect.fromLTWH(0, 0, FCO.scrW, FCO.scrH);
...
// //     if (calloutRect.left > (FCO.scrW - minVisibleH)) {
// //       resultLeft = FCO.scrW - minVisibleH;
// //     }
// //     if (calloutRect.top > (FCO.scrH - minVisibleV - FCO.kbdH)) {
// //       resultTop = FCO.scrH - minVisibleV - FCO.kbdH;
// //     }
...
// // //   String appsVersionAndBuildNum = await FCO.versionAndBuild;
// // //   String? storedVersionAndBuild = FCO.appInfo.versionAndBuildNum ?? '';
// // //   if (appsVersionAndBuildNum != storedVersionAndBuild) {
// // //     FCO.appInfo.versionAndBuildNum = appsVersionAndBuildNum;
// // //     if (false) FCO.modelRepo.saveAppInfo();
// // //     return true;
// // //   }
// // //   return false;
// // // }
...
// // //   // adjust s.t entirely visible
// // //   if (startingCalloutLeft + calloutRect.width > FCO.scrW) {
// // //     resultLeft = FCO.scrW - calloutRect.width;
// // //   }
// // //   if (startingCalloutTop + calloutRect.height > (FCO.scrH - FCO.kbdH)) {
// // //     resultTop = FCO.scrH - calloutRect.height - FCO.kbdH;
// // //   }
...
// //         (paintBounds?.width == FCO.scrW ||
// //             paintBounds?.height == FCO.scrH)) {
// //       _alreadyGaveGlobalPosAndSizeWarning = true;
// //       Callout.showOverlay(
// //         calloutContentF: (BuildContext context) {
// //           return Column(
// //             children: [
// //               FCO.coloredText('Warning - Target Size Constraint',
// //                   color: Colors.red),
// //               Text(
// //                 paintBounds?.width == FCO.scrW
