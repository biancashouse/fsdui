...
class TabNodeMapper extends SubClassMapperBase<TabNode> {
  ...
  static const Field<TabNode, String> _f$name =
  ...
  static EdgeInsets? _$iconMargin(TabNode v) => v.iconMargin;
  static const Field<TabNode, EdgeInsets> _f$iconMargin =
  ...
  static const Field<TabNode, List<String>> _f$tags =
