...
class GoogleDriveIFrameNodeMapper
  ...
  static const Field<GoogleDriveIFrameNode, String> _f$folderId = Field(
    'folderId',
    _$folderId,
    opt: true,
    def: '',
  ...
  static const Field<GoogleDriveIFrameNode, String> _f$resourceKey = Field(
    'resourceKey',
    _$resourceKey,
    opt: true,
    def: '',
  ...
  static const Field<GoogleDriveIFrameNode, double> _f$iframeWidth = Field(
    'iframeWidth',
    _$iframeWidth,
    opt: true,
  );
  static double? _$iframeHeight(GoogleDriveIFrameNode v) => v.iframeHeight;
  static const Field<GoogleDriveIFrameNode, double> _f$iframeHeight = Field(
    'iframeHeight',
    _$iframeHeight,
    opt: true,
  );
  static String _$uid(GoogleDriveIFrameNode v) => v.uid;
  static const Field<GoogleDriveIFrameNode, String> _f$uid = Field(
    'uid',
    _$uid,
  ...
  static const Field<GoogleDriveIFrameNode, bool> _f$isExpanded = Field(
    'isExpanded',
    _$isExpanded,
    mode: FieldMode.member,
  );
...
mixin GoogleDriveIFrameNodeMappable {
  ...
  GoogleDriveIFrameNodeCopyWith<
    GoogleDriveIFrameNode,
    GoogleDriveIFrameNode,
    GoogleDriveIFrameNode
  >
  get copyWith =>
      _GoogleDriveIFrameNodeCopyWithImpl<
        GoogleDriveIFrameNode,
        GoogleDriveIFrameNode
      >(this as GoogleDriveIFrameNode, $identity, $identity);
  @override
  String toString() {
    return GoogleDriveIFrameNodeMapper.ensureInitialized().stringifyValue(
      this as GoogleDriveIFrameNode,
    );
  }

  @override
  bool operator ==(Object other) {
    return GoogleDriveIFrameNodeMapper.ensureInitialized().equalsValue(
      this as GoogleDriveIFrameNode,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return GoogleDriveIFrameNodeMapper.ensureInitialized().hashValue(
      this as GoogleDriveIFrameNode,
    );
  }
}
