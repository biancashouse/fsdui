...
class TabBarViewNodeMapper extends SubClassMapperBase<TabBarViewNode> {
  ...
  static bool _$canShowTappableNodeWidgetOverlay(TabBarViewNode v) =>
      v.canShowTappableNodeWidgetOverlay;
  static const Field<TabBarViewNode, bool> _f$canShowTappableNodeWidgetOverlay =
      Field(
...
class _TabBarViewNodeCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({String? tabBarName, List<SNode>? children}) => $apply(
    FieldCopyWithData({
