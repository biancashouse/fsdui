...
final class UpdateAppRating extends CAPIEvent {
  int? stars;
...
final class SetThemeMode extends CAPIEvent {
  ThemeMode themeMode;
...
final class PublishSnippet extends CAPIEvent {
  PublishSnippet({required this.snippetName, required this.versionId});
...
final class RevertSnippet extends CAPIEvent {
  RevertSnippet({required this.snippetName, required this.versionId});
...
final class SetPanelSnippet extends CAPIEvent {
  SetPanelSnippet({required this.snippetName, required this.panelName});
...
final class PushSnippetEditor extends CAPIEvent {
  PushSnippetEditor({required this.rootNode, this.selectedNode});
...
final class SaveNodeAsSnippet extends CAPIEvent {
  SaveNodeAsSnippet({required this.node, required this.newSnippetName});
...
final class PrependArticle extends CAPIEvent {
  PrependArticle({required this.listNode, this.nodeType, this.testNode});
