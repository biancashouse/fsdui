...
const double CANVAS_PADDING = 0.0;
const double EDGE_THICKNESS = 30.0;
const double MIN_VISIBLE_WIDTH = 60.0;
const double MIN_VISIBLE_HEIGHT = 60.0;
  ...
  Future<void> zoomOrCropImage({
    ...
    fsdui.showOverlay(
      calloutConfig: CalloutConfig(
        ...
        barrier: CalloutBarrierConfig(opacity: .75),
    ...
    if (image != null &&
      ...
      Tween<Offset> offsetTween = Tween(
        begin: Offset.zero,
          ...
          -zoom * (image!.width - widget.calloutSize.width) / 2,
    ...
    if (image != null) {
      ...
      try {
        ...
        ui.Image img = await pic.toImage(
          uncroppedRect.width.floor(),
          uncroppedRect.height.floor(),
        );
...
class ImagePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    RadialGradient gradient = RadialGradient(
      ...
      colors: <Color>[
        Colors.black, // yellow sun
        Colors.yellow, // blue sky
      ],
