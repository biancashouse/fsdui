...
class ContainerStylePropertiesMapper
  ...
  static EdgeInsets? _$margin(ContainerStyleProperties v) => v.margin;
  static const Field<ContainerStyleProperties, EdgeInsets> _f$margin = Field(
    'margin',
    _$margin,
    opt: true,
  );
  static EdgeInsets? _$padding(ContainerStyleProperties v) => v.padding;
  static const Field<ContainerStyleProperties, EdgeInsets> _f$padding = Field(
    'padding',
    _$padding,
    opt: true,
  );
