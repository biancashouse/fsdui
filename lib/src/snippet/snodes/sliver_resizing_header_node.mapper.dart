...
class SliverResizingHeaderNodeMapper
  ...
  static SliverResizingHeaderNodeMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = SliverResizingHeaderNodeMapper._());
  ...
  static String? _$name(SliverResizingHeaderNode v) => v.name;
  static const Field<SliverResizingHeaderNode, String> _f$name =
      Field('name', _$name, opt: true);
  static SNode? _$child(SliverResizingHeaderNode v) => v.child;
  static const Field<SliverResizingHeaderNode, SNode> _f$child =
      Field('child', _$child, opt: true);
  static String _$uid(SliverResizingHeaderNode v) => v.uid;
  static const Field<SliverResizingHeaderNode, String> _f$uid =
      Field('uid', _$uid, mode: FieldMode.member);
  static List<String>? _$tags(SliverResizingHeaderNode v) => v.tags;
  static const Field<SliverResizingHeaderNode, List<String>> _f$tags =
  ...
  static const Field<SliverResizingHeaderNode, bool> _f$isExpanded =
  ...
  static SliverResizingHeaderNode _instantiate(DecodingData data) {
    return SliverResizingHeaderNode(
...
mixin SliverResizingHeaderNodeMappable {
  ...
  SliverResizingHeaderNodeCopyWith<SliverResizingHeaderNode,
          SliverResizingHeaderNode, SliverResizingHeaderNode>
      get copyWith => _SliverResizingHeaderNodeCopyWithImpl<
              SliverResizingHeaderNode, SliverResizingHeaderNode>(
          this as SliverResizingHeaderNode, $identity, $identity);
  @override
  String toString() {
    return SliverResizingHeaderNodeMapper.ensureInitialized()
        .stringifyValue(this as SliverResizingHeaderNode);
  }

  @override
  bool operator ==(Object other) {
    return SliverResizingHeaderNodeMapper.ensureInitialized()
        .equalsValue(this as SliverResizingHeaderNode, other);
  }

  @override
  int get hashCode {
    return SliverResizingHeaderNodeMapper.ensureInitialized()
        .hashValue(this as SliverResizingHeaderNode);
  }
}
...
extension SliverResizingHeaderNodeValueCopy<$R, $Out>
  ...
  SliverResizingHeaderNodeCopyWith<$R, SliverResizingHeaderNode, $Out>
      get $asSliverResizingHeaderNode => $base.as((v, t, t2) =>
          _SliverResizingHeaderNodeCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _SliverResizingHeaderNodeCopyWithImpl<$R, $Out>
  ...
  @override
  SliverResizingHeaderNode $make(CopyWithData data) => SliverResizingHeaderNode(
