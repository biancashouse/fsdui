...
class TabDataNodeMapper extends SubClassMapperBase<TabDataNode> {
  ...
  static const Field<TabDataNode, String> _f$title =
      Field('title', _$title, opt: true, def: 'unnamed tab');
  static SNode? _$child(TabDataNode v) => v.child;
  static const Field<TabDataNode, SNode> _f$child =
      Field('child', _$child, opt: true);
  static String _$uid(TabDataNode v) => v.uid;
  static const Field<TabDataNode, String> _f$uid =
      Field('uid', _$uid, mode: FieldMode.member);
  static String? _$name(TabDataNode v) => v.name;
  static const Field<TabDataNode, String> _f$name =
      Field('name', _$name, mode: FieldMode.member);
  static List<String>? _$tags(TabDataNode v) => v.tags;
  static const Field<TabDataNode, List<String>> _f$tags =
  ...
  static const Field<TabDataNode, bool> _f$isExpanded =
...
mixin TabDataNodeMappable {
  String toJson() {
    return TabDataNodeMapper.ensureInitialized()
        .encodeJson<TabDataNode>(this as TabDataNode);
  }

  Map<String, dynamic> toMap() {
    return TabDataNodeMapper.ensureInitialized()
        .encodeMap<TabDataNode>(this as TabDataNode);
  }

  TabDataNodeCopyWith<TabDataNode, TabDataNode, TabDataNode> get copyWith =>
      _TabDataNodeCopyWithImpl<TabDataNode, TabDataNode>(
          this as TabDataNode, $identity, $identity);
  @override
  String toString() {
    return TabDataNodeMapper.ensureInitialized()
        .stringifyValue(this as TabDataNode);
  }

  @override
  bool operator ==(Object other) {
    return TabDataNodeMapper.ensureInitialized()
        .equalsValue(this as TabDataNode, other);
  }
...
class _TabDataNodeCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({String? title, Object? child = $none}) => $apply(FieldCopyWithData(
      {if (title != null) #title: title, if (child != $none) #child: child}));
  @override
