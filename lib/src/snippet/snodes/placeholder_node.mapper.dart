...
class PlaceholderNodeMapper extends SubClassMapperBase<PlaceholderNode> {
  ...
  static const Field<PlaceholderNode, String> _f$name = Field(
    'name',
    _$name,
    opt: true,
  );
  static double? _$width(PlaceholderNode v) => v.width;
  static const Field<PlaceholderNode, double> _f$width = Field(
    'width',
    _$width,
    opt: true,
  );
  static double? _$height(PlaceholderNode v) => v.height;
  static const Field<PlaceholderNode, double> _f$height = Field(
    'height',
    _$height,
    opt: true,
  );
  static String _$uid(PlaceholderNode v) => v.uid;
  static const Field<PlaceholderNode, String> _f$uid = Field(
    'uid',
    _$uid,
    mode: FieldMode.member,
  );
  static List<String>? _$tags(PlaceholderNode v) => v.tags;
  static const Field<PlaceholderNode, List<String>> _f$tags = Field(
    'tags',
    _$tags,
    mode: FieldMode.member,
  );
  ...
  static const Field<PlaceholderNode, bool> _f$isExpanded = Field(
    'isExpanded',
    _$isExpanded,
    mode: FieldMode.member,
  );
  ...
  static GlobalKey<State<StatefulWidget>>? _$nodeGK(PlaceholderNode v) =>
      v.nodeGK;
  static const Field<PlaceholderNode, GlobalKey<State<StatefulWidget>>>
...
mixin PlaceholderNodeMappable {
  ...
  Map<String, dynamic> toMap() {
    return PlaceholderNodeMapper.ensureInitialized().encodeMap<PlaceholderNode>(
      this as PlaceholderNode,
    );
  }
  ...
  @override
  String toString() {
    return PlaceholderNodeMapper.ensureInitialized().stringifyValue(
      this as PlaceholderNode,
    );
  }
  ...
  bool operator ==(Object other) {
    return PlaceholderNodeMapper.ensureInitialized().equalsValue(
      this as PlaceholderNode,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PlaceholderNodeMapper.ensureInitialized().hashValue(
      this as PlaceholderNode,
    );
  }
}
