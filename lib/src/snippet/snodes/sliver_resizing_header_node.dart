...
class SliverResizingHeaderNode extends SC with SliverResizingHeaderNodeMappable {
  ...
  List<PNode> propertyNodes(BuildContext context, SNode? parentSNode) => [
    FlutterDocPNode(
        buttonLabel: 'SliverResizingHeader',
        webLink: 'https://api.flutter.dev/flutter/widgets/SliverResizingHeader-class.html',
        snode: this,
        name: 'fyi')
  ];
  ...
  static const String FLUTTER_TYPE = "SliverResizingHeader";
