...
class UpTo6ColorsMapper extends ClassMapperBase<UpTo6Colors> {
  ...
  static const Field<UpTo6Colors, Color> _f$color1 = Field(
    'color1',
    _$color1,
    opt: true,
  );
  static Color? _$color2(UpTo6Colors v) => v.color2;
  static const Field<UpTo6Colors, Color> _f$color2 = Field(
    'color2',
    _$color2,
    opt: true,
  );
  static Color? _$color3(UpTo6Colors v) => v.color3;
  static const Field<UpTo6Colors, Color> _f$color3 = Field(
    'color3',
    _$color3,
    opt: true,
  );
  static Color? _$color4(UpTo6Colors v) => v.color4;
  static const Field<UpTo6Colors, Color> _f$color4 = Field(
    'color4',
    _$color4,
    opt: true,
  );
  static Color? _$color5(UpTo6Colors v) => v.color5;
  static const Field<UpTo6Colors, Color> _f$color5 = Field(
    'color5',
    _$color5,
    opt: true,
  );
  static Color? _$color6(UpTo6Colors v) => v.color6;
  static const Field<UpTo6Colors, Color> _f$color6 = Field(
    'color6',
    _$color6,
    opt: true,
  );
