...
class ColumnNodeMapper extends SubClassMapperBase<ColumnNode> {
  ...
  static const Field<ColumnNode, String> _f$name =
  ...
  static AxisEnum _$direction(ColumnNode v) => v.direction;
  static const Field<ColumnNode, AxisEnum> _f$direction =
      Field('direction', _$direction, opt: true, def: AxisEnum.vertical);
  ...
  static const Field<ColumnNode, List<String>> _f$tags =
