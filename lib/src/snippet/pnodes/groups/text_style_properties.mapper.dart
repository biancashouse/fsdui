...
class TextStylePropertiesMapper extends ClassMapperBase<TextStyleProperties> {
  ...
  static const Field<TextStyleProperties, String> _f$fontFamily =
      Field('fontFamily', _$fontFamily, opt: true);
  static double? _$fontSize(TextStyleProperties v) => v.fontSize;
  static const Field<TextStyleProperties, double> _f$fontSize =
  ...
  static Color? _$color(TextStyleProperties v) => v.color;
  static const Field<TextStyleProperties, Color> _f$color =
...
mixin TextStylePropertiesMappable {
  ...
  String toString() {
    return TextStylePropertiesMapper.ensureInitialized()
        .stringifyValue(this as TextStyleProperties);
  }

  @override
  bool operator ==(Object other) {
    return TextStylePropertiesMapper.ensureInitialized()
        .equalsValue(this as TextStyleProperties, other);
  }

  @override
  int get hashCode {
    return TextStylePropertiesMapper.ensureInitialized()
        .hashValue(this as TextStyleProperties);
  }
}
