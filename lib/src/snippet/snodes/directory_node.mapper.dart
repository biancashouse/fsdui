...
class DirectoryNodeMapper extends SubClassMapperBase<DirectoryNode> {
  ...
  static bool _$is3rdParty(DirectoryNode v) => v.is3rdParty;
  static const Field<DirectoryNode, bool> _f$is3rdParty = Field(
    'is3rdParty',
    _$is3rdParty,
    mode: FieldMode.member,
  );
...
extension DirectoryNodeValueCopy<$R, $Out>
  ...
  DirectoryNodeCopyWith<$R, DirectoryNode, $Out> get $asDirectoryNode =>
      $base.as((v, t, t2) => _DirectoryNodeCopyWithImpl<$R, $Out>(v, t, t2));
}
