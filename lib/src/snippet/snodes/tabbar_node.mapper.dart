...
class TabBarNodeMapper extends SubClassMapperBase<TabBarNode> {
  ...
  static const Field<TabBarNode, ColorModel> _f$selectedLabelColor = Field(
    'selectedLabelColor',
  ...
  static const Field<TabBarNode, ColorModel> _f$unselectedLabelColor = Field(
    'unselectedLabelColor',
    _$unselectedLabelColor,
    opt: true,
  );
  static ColorModel? _$indicatorColor(TabBarNode v) => v.indicatorColor;
  static const Field<TabBarNode, ColorModel> _f$indicatorColor = Field(
    'indicatorColor',
    _$indicatorColor,
    opt: true,
  );
...
class _TabBarNodeCopyWithImpl<$R, $Out>
  ...
  @override
  ColorModelCopyWith<$R, ColorModel, ColorModel>? get selectedLabelColor =>
      $value.selectedLabelColor?.copyWith.$chain(
        (v) => call(selectedLabelColor: v),
      );
  @override
  ColorModelCopyWith<$R, ColorModel, ColorModel>? get unselectedLabelColor =>
      $value.unselectedLabelColor?.copyWith.$chain(
        (v) => call(unselectedLabelColor: v),
      );
  @override
  ColorModelCopyWith<$R, ColorModel, ColorModel>? get indicatorColor =>
