...
class YTNodeMapper extends SubClassMapperBase<YTNode> {
  ...
  static const Field<YTNode, double> _f$scale =
  ...
  static const Field<YTNode, List<String>> _f$tags =
...
class _YTNodeCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, YTNode, $Out>
  ...
  @override
  $R call({Object? name = $none, String? ytEmbedHtml, double? scale}) =>
