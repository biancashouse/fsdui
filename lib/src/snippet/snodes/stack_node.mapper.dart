...
class StackNodeMapper extends SubClassMapperBase<StackNode> {
  ...
  static PTreeNodeTreeController? _$pTreeC(StackNode v) => v.pTreeC;
  static const Field<StackNode, PTreeNodeTreeController> _f$pTreeC =
      Field('pTreeC', _$pTreeC, mode: FieldMode.member);
  static double? _$propertiesPaneScrollPos(StackNode v) =>
      v.propertiesPaneScrollPos;
  static const Field<StackNode, double> _f$propertiesPaneScrollPos = Field(
      'propertiesPaneScrollPos', _$propertiesPaneScrollPos,
      mode: FieldMode.member);
  static ScrollController? _$propertiesPaneSC(StackNode v) =>
      v.propertiesPaneSC;
  static const Field<StackNode, ScrollController> _f$propertiesPaneSC =
