...
class PollOptionNodeMapper extends SubClassMapperBase<PollOptionNode> {
  ...
  static const Field<PollOptionNode, String> _f$name =
  ...
  static const Field<PollOptionNode, List<String>> _f$tags =
...
class _PollOptionNodeCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({Object? name = $none, String? text}) => $apply(FieldCopyWithData(
      {if (name != $none) #name: name, if (text != null) #text: text}));
  @override
