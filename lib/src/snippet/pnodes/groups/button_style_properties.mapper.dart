...
class ButtonStylePropertiesMapper
  ...
  static Color? _$fgColor(ButtonStyleProperties v) => v.fgColor;
  static const Field<ButtonStyleProperties, Color> _f$fgColor =
      Field('fgColor', _$fgColor, opt: true);
  static Color? _$bgColor(ButtonStyleProperties v) => v.bgColor;
  static const Field<ButtonStyleProperties, Color> _f$bgColor =
...
mixin ButtonStylePropertiesMappable {
  ...
  ButtonStylePropertiesCopyWith<ButtonStyleProperties, ButtonStyleProperties,
      ButtonStyleProperties> get copyWith => _ButtonStylePropertiesCopyWithImpl<
