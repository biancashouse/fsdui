...
class PaddingNodeMapper extends SubClassMapperBase<PaddingNode> {
  ...
  static PTreeNodeTreeController? _$pTreeC(PaddingNode v) => v.pTreeC;
  static const Field<PaddingNode, PTreeNodeTreeController> _f$pTreeC =
      Field('pTreeC', _$pTreeC, mode: FieldMode.member);
  static double? _$propertiesPaneScrollPos(PaddingNode v) =>
      v.propertiesPaneScrollPos;
  static const Field<PaddingNode, double> _f$propertiesPaneScrollPos = Field(
      'propertiesPaneScrollPos', _$propertiesPaneScrollPos,
      mode: FieldMode.member);
  static ScrollController? _$propertiesPaneSC(PaddingNode v) =>
      v.propertiesPaneSC;
  static const Field<PaddingNode, ScrollController> _f$propertiesPaneSC =
    ...
    return identical(this, other) ||
        (runtimeType == other.runtimeType &&
            PaddingNodeMapper.ensureInitialized()
                .isValueEqual(this as PaddingNode, other));
  }
