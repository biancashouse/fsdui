...
class StorageImageNodeMapper extends SubClassMapperBase<StorageImageNode> {
  ...
  static bool _$canShowTappableNodeWidgetOverlay(StorageImageNode v) =>
      v.canShowTappableNodeWidgetOverlay;
  static const Field<StorageImageNode, bool>
  _f$canShowTappableNodeWidgetOverlay = Field(
    'canShowTappableNodeWidgetOverlay',
    _$canShowTappableNodeWidgetOverlay,
    mode: FieldMode.member,
  );
  static GlobalKey<State<StatefulWidget>>? _$nodeWidgetGK(StorageImageNode v) =>
      v.nodeWidgetGK;
  static const Field<StorageImageNode, GlobalKey<State<StatefulWidget>>>
