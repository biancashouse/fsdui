  ...
  static DashboardLayoutItemModelMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = DashboardLayoutItemModelMapper._());
    }
    return _instance!;
  }
...
mixin DashboardLayoutItemModelMappable {
  ...
  DashboardLayoutItemModelCopyWith<DashboardLayoutItemModel,
          DashboardLayoutItemModel, DashboardLayoutItemModel>
      get copyWith => _DashboardLayoutItemModelCopyWithImpl<
              DashboardLayoutItemModel, DashboardLayoutItemModel>(
          this as DashboardLayoutItemModel, $identity, $identity);
  @override
  String toString() {
    return DashboardLayoutItemModelMapper.ensureInitialized()
        .stringifyValue(this as DashboardLayoutItemModel);
  }

  @override
  bool operator ==(Object other) {
    return DashboardLayoutItemModelMapper.ensureInitialized()
        .equalsValue(this as DashboardLayoutItemModel, other);
  }

  @override
  int get hashCode {
    return DashboardLayoutItemModelMapper.ensureInitialized()
        .hashValue(this as DashboardLayoutItemModel);
  }
}
...
extension DashboardLayoutItemModelValueCopy<$R, $Out>
  ...
  DashboardLayoutItemModelCopyWith<$R, DashboardLayoutItemModel, $Out>
      get $asDashboardLayoutItemModel => $base.as((v, t, t2) =>
          _DashboardLayoutItemModelCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _DashboardLayoutItemModelCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({int? x, int? y, int? w, int? h}) => $apply(FieldCopyWithData({
        if (x != null) #x: x,
        if (y != null) #y: y,
        if (w != null) #w: w,
        if (h != null) #h: h
