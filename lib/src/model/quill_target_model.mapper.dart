...
class QuillTargetModelMapper extends ClassMapperBase<QuillTargetModel> {
  ...
  static const Field<QuillTargetModel, double> _f$iconSize =
  ...
  static const Field<QuillTargetModel, int> _f$calloutDurationMs =
  ...
  static const Field<QuillTargetModel, double> _f$calloutBorderRadius =
  ...
  static const Field<QuillTargetModel, int> _f$starPoints =
  ...
  static Color? _$bubbleOrTargetPointerColor(QuillTargetModel v) =>
      v.bubbleOrTargetPointerColor;
  static const Field<QuillTargetModel, Color> _f$bubbleOrTargetPointerColor =
  ...
  static const Field<QuillTargetModel, bool> _f$animatePointer =
      Field('animatePointer', _$animatePointer, opt: true, def: false);
  static bool _$autoPlay(QuillTargetModel v) => v.autoPlay;
  static const Field<QuillTargetModel, bool> _f$autoPlay =
  ...
  QuillTargetModelCopyWith<QuillTargetModel, QuillTargetModel, QuillTargetModel>
      get copyWith =>
          _QuillTargetModelCopyWithImpl<QuillTargetModel, QuillTargetModel>(
              this as QuillTargetModel, $identity, $identity);
  @override
  String toString() {
    return QuillTargetModelMapper.ensureInitialized()
        .stringifyValue(this as QuillTargetModel);
  }

  @override
  bool operator ==(Object other) {
    return QuillTargetModelMapper.ensureInitialized()
        .equalsValue(this as QuillTargetModel, other);
  }

  @override
  int get hashCode {
    return QuillTargetModelMapper.ensureInitialized()
        .hashValue(this as QuillTargetModel);
  }
}
...
extension QuillTargetModelValueCopy<$R, $Out>
  ...
  QuillTargetModelCopyWith<$R, QuillTargetModel, $Out>
      get $asQuillTargetModel => $base
          .as((v, t, t2) => _QuillTargetModelCopyWithImpl<$R, $Out>(v, t, t2));
}
