...
mixin NavMixin {
  Widget NavigationDD({Color pencilIconColor = Colors.white}) =>
      BlocBuilder<CAPIBloC, CAPIState>(
        builder: (context, state) {
              bool showPencil = !fco.authenticated;
              if (showPencil) {
  ...
  Widget _pageNavBtn(BuildContext context, String pagePath, String sandboxIndicator) => GestureDetector(
    onTap: () {
      context.go(pagePath);
    },
    child: SizedBox(
