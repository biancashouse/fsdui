...
enum SnippetTemplateEnum {
  ...
  SnippetRootNode templateSnippet() {
    ...
    return switch (this) {
      ...
      //
      SnippetTemplateEnum.drive_iframe => SnippetRootNode(name: SnippetTemplateEnum.drive_iframe.name, child: IFrameNode()),
      //
      SnippetTemplateEnum.markdown => SnippetRootNode(name: SnippetTemplateEnum.markdown.name, child: MarkdownNode()),
      //
          ...
          appBar: AppBarNode(
            ...
            bottom: GenericSingleChildNode(
              ...
              child: MenuBarNode(
                children: [
                  MenuItemButtonNode(
                    child: TextNode(text: 'item 1', tsPropGroup: TextStyleProperties()),
                    bsPropGroup: ButtonStyleProperties(tsPropGroup: TextStyleProperties()),
                  ),
                  MenuItemButtonNode(
                    child: TextNode(text: 'item 2', tsPropGroup: TextStyleProperties()),
                    bsPropGroup: ButtonStyleProperties(tsPropGroup: TextStyleProperties()),
                  ),
                  MenuItemButtonNode(
                    child: TextNode(text: 'item 3', tsPropGroup: TextStyleProperties()),
                    bsPropGroup: ButtonStyleProperties(tsPropGroup: TextStyleProperties()),
                  ),
                ],
              ),
      ...
      SnippetTemplateEnum.splitview_with_2_placeholders => SnippetRootNode(
        ...
        child: SplitViewNode(axis: AxisEnum.vertical, children: [PlaceholderNode(), PlaceholderNode()]),
      ),
      //
      SnippetTemplateEnum.rich_text => SnippetRootNode(
        ...
        child: RichTextNode(
          text: TextSpanNode(
            ...
            children: [TextSpanNode(text: ' def', tsPropGroup: TextStyleProperties())],
          ),
        ),
      ),
      //
  ...
  Widget toWidget(BuildContext context, SNode? parentNode, {double? appBarHeight}) => templateSnippet().toWidget(context, parentNode);
