...
class SubmenuButtonNodeMapper extends SubClassMapperBase<SubmenuButtonNode> {
  ...
  static const Field<SubmenuButtonNode, String> _f$name =
  ...
  static const Field<SubmenuButtonNode, List<SNode>> _f$children =
      Field('children', _$children, key: r'menuChildren');
  ...
  static const Field<SubmenuButtonNode, List<String>> _f$tags =
