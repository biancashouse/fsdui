  ...
  List<PNode> propertyNodes(BuildContext context, SNode? parentSNode) => [
    ...
    EnumPNode<AxisEnum?>(
      ...
      onIndexChange: (newValue) => refreshWithUpdate(
        context,
        () => direction = AxisEnum.of(newValue) ?? AxisEnum.horizontal,
      ),
    ),
    DecimalPNode(
      snode: this,
    ...
    EnumPNode<WrapAlignmentEnumModel?>(
      ...
      onIndexChange: (newValue) => refreshWithUpdate(
        context,
        () => alignment = WrapAlignmentEnumModel.of(newValue),
      ),
    ),
