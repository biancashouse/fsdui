...
class IntrinsicHeightNodeMapper
  ...
  static String? _$name(IntrinsicHeightNode v) => v.name;
  static const Field<IntrinsicHeightNode, String> _f$name =
      Field('name', _$name, opt: true);
  static SNode? _$child(IntrinsicHeightNode v) => v.child;
  static const Field<IntrinsicHeightNode, SNode> _f$child =
      Field('child', _$child, opt: true);
  static String _$uid(IntrinsicHeightNode v) => v.uid;
  static const Field<IntrinsicHeightNode, String> _f$uid =
      Field('uid', _$uid, mode: FieldMode.member);
  static List<String>? _$tags(IntrinsicHeightNode v) => v.tags;
  static const Field<IntrinsicHeightNode, List<String>> _f$tags =
  ...
  static const Field<IntrinsicHeightNode, bool> _f$isExpanded =
...
mixin IntrinsicHeightNodeMappable {
  ...
  IntrinsicHeightNodeCopyWith<IntrinsicHeightNode, IntrinsicHeightNode,
      IntrinsicHeightNode> get copyWith => _IntrinsicHeightNodeCopyWithImpl<
          IntrinsicHeightNode, IntrinsicHeightNode>(
      this as IntrinsicHeightNode, $identity, $identity);
  @override
  String toString() {
    return IntrinsicHeightNodeMapper.ensureInitialized()
        .stringifyValue(this as IntrinsicHeightNode);
  }

  @override
  bool operator ==(Object other) {
    return IntrinsicHeightNodeMapper.ensureInitialized()
        .equalsValue(this as IntrinsicHeightNode, other);
  }

  @override
  int get hashCode {
    return IntrinsicHeightNodeMapper.ensureInitialized()
        .hashValue(this as IntrinsicHeightNode);
  }
}
...
abstract class IntrinsicHeightNodeCopyWith<$R, $In extends IntrinsicHeightNode,
...
class _IntrinsicHeightNodeCopyWithImpl<$R, $Out>
  ...
  @override
  IntrinsicHeightNode $make(CopyWithData data) => IntrinsicHeightNode(
