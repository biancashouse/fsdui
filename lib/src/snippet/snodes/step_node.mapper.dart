...
class StepNodeMapper extends SubClassMapperBase<StepNode> {
  ...
  static PTreeNodeTreeController? _$pTreeC(StepNode v) => v.pTreeC;
  static const Field<StepNode, PTreeNodeTreeController> _f$pTreeC =
      Field('pTreeC', _$pTreeC, mode: FieldMode.member);
  static double? _$propertiesPaneScrollPos(StepNode v) =>
      v.propertiesPaneScrollPos;
  static const Field<StepNode, double> _f$propertiesPaneScrollPos = Field(
      'propertiesPaneScrollPos', _$propertiesPaneScrollPos,
      mode: FieldMode.member);
  static ScrollController? _$propertiesPaneSC(StepNode v) => v.propertiesPaneSC;
  static const Field<StepNode, ScrollController> _f$propertiesPaneSC =
    ...
    return identical(this, other) ||
        (runtimeType == other.runtimeType &&
            StepNodeMapper.ensureInitialized()
                .isValueEqual(this as StepNode, other));
  }
