...
// in flutter_callouts/test/root_context_mixin_test.dart.
...
import 'package:flutter/src/widgets/overlay.dart' as _i7;
...
class _FakeFocusNode_3 extends _i1.SmartFake implements _i4.FocusNode {
  _FakeFocusNode_3(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
...
class _FakeNavigator_5 extends _i1.SmartFake implements _i5.Navigator {
  _FakeNavigator_5(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
...
class _FakeBuildContext_6 extends _i1.SmartFake implements _i2.BuildContext {
  _FakeBuildContext_6(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class _FakeOverlay_8 extends _i1.SmartFake implements _i7.Overlay {
  _FakeOverlay_8(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
...
class MockNavigatorState extends _i1.Mock implements _i5.NavigatorState {
  ...
  _i4.FocusNode get focusNode =>
      (super.noSuchMethod(
            ...
            returnValue: _FakeFocusNode_3(this, Invocation.getter(#focusNode)),
          )
          as _i4.FocusNode);
  ...
  _i5.Navigator get widget =>
      (super.noSuchMethod(
            Invocation.getter(#widget),
            returnValue: _FakeNavigator_5(this, Invocation.getter(#widget)),
          )
          as _i5.Navigator);
  ...
  _i2.BuildContext get context =>
      (super.noSuchMethod(
            ...
            returnValue: _FakeBuildContext_6(this, Invocation.getter(#context)),
          )
          as _i2.BuildContext);
...
///
/// See the documentation for Mockito's code generation for more information.
class MockOverlayState extends _i1.Mock implements _i7.OverlayState {
  MockOverlayState() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i7.Overlay get widget =>
      (super.noSuchMethod(
            Invocation.getter(#widget),
            returnValue: _FakeOverlay_8(this, Invocation.getter(#widget)),
          )
          as _i7.Overlay);
  ...
  @override
  void insert(
    _i7.OverlayEntry? entry, {
    _i7.OverlayEntry? below,
    _i7.OverlayEntry? above,
  }) => super.noSuchMethod(
  ...
  @override
  void insertAll(
    Iterable<_i7.OverlayEntry>? entries, {
    _i7.OverlayEntry? below,
    _i7.OverlayEntry? above,
  }) => super.noSuchMethod(
  ...
  @override
  void rearrange(
    Iterable<_i7.OverlayEntry>? newEntries, {
    _i7.OverlayEntry? below,
    _i7.OverlayEntry? above,
  }) => super.noSuchMethod(
  ...
  @override
  bool debugIsVisible(_i7.OverlayEntry? entry) =>
      (super.noSuchMethod(
  ...
  @override
  void didUpdateWidget(_i7.Overlay? oldWidget) => super.noSuchMethod(
    Invocation.method(#didUpdateWidget, [oldWidget]),
    returnValueForMissingStub: null,
  );
