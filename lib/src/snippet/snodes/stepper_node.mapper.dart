...
class StepperNodeMapper extends SubClassMapperBase<StepperNode> {
  ...
  static const Field<StepperNode, StepperTypeEnum> _f$type = Field(
    'type',
    _$type,
    opt: true,
    def: StepperTypeEnum.vertical,
  );
  static String? _$name(StepperNode v) => v.name;
  static const Field<StepperNode, String> _f$name = Field(
    'name',
    _$name,
    opt: true,
  );
  static List<SNode> _$children(StepperNode v) => v.children;
  static const Field<StepperNode, List<SNode>> _f$children = Field(
    'children',
    _$children,
  );
  static String _$uid(StepperNode v) => v.uid;
  static const Field<StepperNode, String> _f$uid = Field(
    'uid',
    _$uid,
  ...
  static const Field<StepperNode, bool> _f$isExpanded = Field(
    'isExpanded',
    _$isExpanded,
    mode: FieldMode.member,
  );
  ...
  static GlobalKey<State<StatefulWidget>>? _$nodeGK(StepperNode v) => v.nodeGK;
  static const Field<StepperNode, GlobalKey<State<StatefulWidget>>> _f$nodeGK =
      Field('nodeGK', _$nodeGK, mode: FieldMode.member);
  static bool _$canShowTappableNodeWidgetOverlay(StepperNode v) =>
      v.canShowTappableNodeWidgetOverlay;
  static const Field<StepperNode, bool> _f$canShowTappableNodeWidgetOverlay =
      Field(
...
mixin StepperNodeMappable {
  String toJson() {
    return StepperNodeMapper.ensureInitialized().encodeJson<StepperNode>(
      this as StepperNode,
    );
  }

  Map<String, dynamic> toMap() {
    return StepperNodeMapper.ensureInitialized().encodeMap<StepperNode>(
      this as StepperNode,
    );
  }
  ...
  @override
  String toString() {
    return StepperNodeMapper.ensureInitialized().stringifyValue(
      this as StepperNode,
    );
  }
  ...
  bool operator ==(Object other) {
    return StepperNodeMapper.ensureInitialized().equalsValue(
      this as StepperNode,
      other,
    );
  }
