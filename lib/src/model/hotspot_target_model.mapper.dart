...
class HotspotTargetModelMapper extends ClassMapperBase<HotspotTargetModel> {
  ...
  static OffsetModel? _$targetCLocalPc(HotspotTargetModel v) =>
      v.targetCLocalPc;
  static const Field<HotspotTargetModel, OffsetModel> _f$targetCLocalPc =
      Field('targetCLocalPc', _$targetCLocalPc, opt: true);
  static OffsetModel? _$btnCLocalPosPc(HotspotTargetModel v) =>
      v.btnCLocalPosPc;
  static const Field<HotspotTargetModel, OffsetModel> _f$btnCLocalPosPc =
      Field('btnCLocalPosPc', _$btnCLocalPosPc, opt: true);
  static double? _$targetRadiusPC(HotspotTargetModel v) => v.targetRadiusPC;
  static const Field<HotspotTargetModel, double> _f$targetRadiusPC =
      Field('targetRadiusPC', _$targetRadiusPC, opt: true);
  static double? _$btnRadiusPc(HotspotTargetModel v) => v.btnRadiusPc;
  static const Field<HotspotTargetModel, double> _f$btnRadiusPc =
      Field('btnRadiusPc', _$btnRadiusPc, opt: true);
  ...
  static const Field<HotspotTargetModel, bool> _f$showCover =
      Field('showCover', _$showCover, opt: true, def: true);
  static bool _$showBtn(HotspotTargetModel v) => v.showBtn;
  static const Field<HotspotTargetModel, bool> _f$showBtn =
  ...
  static const Field<HotspotTargetModel, AlignmentModel> _f$tcAlignment =
      Field('tcAlignment', _$tcAlignment, opt: true);
  ...
  static const Field<HotspotTargetModel, SizeModel> _f$calloutSize = Field(
      'calloutSize', _$calloutSize,
      opt: true, def: const SizeModel(200, 80));
  static int _$calloutDurationMs(HotspotTargetModel v) => v.calloutDurationMs;
  static const Field<HotspotTargetModel, int> _f$calloutDurationMs =
  ...
  static const Field<HotspotTargetModel, double> _f$calloutBorderRadius =
      Field('calloutBorderRadius', _$calloutBorderRadius, opt: true);
  ...
  static const Field<HotspotTargetModel, int> _f$starPoints =
  ...
  static Color? _$bubbleOrTargetPointerColor(HotspotTargetModel v) =>
      v.bubbleOrTargetPointerColor;
  static const Field<HotspotTargetModel, Color> _f$bubbleOrTargetPointerColor =
  ...
  static const Field<HotspotTargetModel, bool> _f$animatePointer =
      Field('animatePointer', _$animatePointer, opt: true, def: false);
  static bool _$autoPlay(HotspotTargetModel v) => v.autoPlay;
  static const Field<HotspotTargetModel, bool> _f$autoPlay =
...
mixin HotspotTargetModelMappable {
  ...
  HotspotTargetModelCopyWith<HotspotTargetModel, HotspotTargetModel,
          HotspotTargetModel>
      get copyWith => _HotspotTargetModelCopyWithImpl<HotspotTargetModel,
          HotspotTargetModel>(this as HotspotTargetModel, $identity, $identity);
  @override
  String toString() {
    return HotspotTargetModelMapper.ensureInitialized()
        .stringifyValue(this as HotspotTargetModel);
  }

  @override
  bool operator ==(Object other) {
    return HotspotTargetModelMapper.ensureInitialized()
        .equalsValue(this as HotspotTargetModel, other);
  }

  @override
  int get hashCode {
    return HotspotTargetModelMapper.ensureInitialized()
        .hashValue(this as HotspotTargetModel);
  }
}
...
abstract class HotspotTargetModelCopyWith<$R, $In extends HotspotTargetModel,
