...
class FSImageNodeMapper extends SubClassMapperBase<FSImageNode> {
  ...
  static const Field<FSImageNode, BoxFitEnum> _f$fit = Field(
    'fit',
    _$fit,
    opt: true,
  );
  static AlignmentEnum? _$alignment(FSImageNode v) => v.alignment;
  static const Field<FSImageNode, AlignmentEnum> _f$alignment = Field(
    'alignment',
    _$alignment,
    opt: true,
  );
  static double? _$width(FSImageNode v) => v.width;
  static const Field<FSImageNode, double> _f$width = Field(
    'width',
    _$width,
    opt: true,
  );
  static double? _$height(FSImageNode v) => v.height;
  static const Field<FSImageNode, double> _f$height = Field(
    'height',
    _$height,
    opt: true,
  );
  static double? _$scale(FSImageNode v) => v.scale;
  static const Field<FSImageNode, double> _f$scale = Field(
    'scale',
    _$scale,
    opt: true,
  );
  static String _$uid(FSImageNode v) => v.uid;
  static const Field<FSImageNode, String> _f$uid = Field(
    'uid',
    _$uid,
    mode: FieldMode.member,
  );
  static GlobalKey<State<StatefulWidget>>? _$treeNodeGK(FSImageNode v) =>
      v.treeNodeGK;
  ...
  static const Field<FSImageNode, bool> _f$isExpanded = Field(
    'isExpanded',
    _$isExpanded,
    mode: FieldMode.member,
  );
...
mixin FSImageNodeMappable {
  String toJson() {
    return FSImageNodeMapper.ensureInitialized().encodeJson<FSImageNode>(
      this as FSImageNode,
    );
  }

  Map<String, dynamic> toMap() {
    return FSImageNodeMapper.ensureInitialized().encodeMap<FSImageNode>(
      this as FSImageNode,
    );
  }

  FSImageNodeCopyWith<FSImageNode, FSImageNode, FSImageNode> get copyWith =>
      _FSImageNodeCopyWithImpl<FSImageNode, FSImageNode>(
        this as FSImageNode,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return FSImageNodeMapper.ensureInitialized().stringifyValue(
      this as FSImageNode,
    );
  }
  ...
  bool operator ==(Object other) {
    return FSImageNodeMapper.ensureInitialized().equalsValue(
      this as FSImageNode,
      other,
    );
  }
...
extension FSImageNodeValueCopy<$R, $Out>
  ...
  FSImageNodeCopyWith<$R, FSImageNode, $Out> get $asFSImageNode =>
      $base.as((v, t, t2) => _FSImageNodeCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _FSImageNodeCopyWithImpl<$R, $Out>
  ...
  FSImageNodeCopyWith<$R2, FSImageNode, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _FSImageNodeCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
