...
class TabBarNodeMapper extends SubClassMapperBase<TabBarNode> {
  ...
  static const Field<TabBarNode, String> _f$name = Field(
    'name',
    _$name,
    opt: true,
  );
  static Color? _$bgColor(TabBarNode v) => v.bgColor;
  static const Field<TabBarNode, Color> _f$bgColor = Field(
    'bgColor',
    _$bgColor,
    opt: true,
  );
  ...
  static Color? _$selectedLabelColor(TabBarNode v) => v.selectedLabelColor;
  static const Field<TabBarNode, Color> _f$selectedLabelColor = Field(
    'selectedLabelColor',
    _$selectedLabelColor,
    opt: true,
  );
  static Color? _$unselectedLabelColor(TabBarNode v) => v.unselectedLabelColor;
  static const Field<TabBarNode, Color> _f$unselectedLabelColor = Field(
    'unselectedLabelColor',
    _$unselectedLabelColor,
    opt: true,
  );
  static Color _$indicatorColor(TabBarNode v) => v.indicatorColor;
  static const Field<TabBarNode, Color> _f$indicatorColor = Field(
    'indicatorColor',
    _$indicatorColor,
    opt: true,
    def: Colors.blue,
  ...
  static const Field<TabBarNode, double> _f$indicatorWeight = Field(
    'indicatorWeight',
    _$indicatorWeight,
    opt: true,
    def: 2.0,
  ...
  static const Field<TabBarNode, int> _f$selection = Field(
    'selection',
    _$selection,
    opt: true,
  );
  static List<SNode> _$children(TabBarNode v) => v.children;
  static const Field<TabBarNode, List<SNode>> _f$children = Field(
    'children',
    _$children,
  );
  static String _$uid(TabBarNode v) => v.uid;
  static const Field<TabBarNode, String> _f$uid = Field(
    'uid',
    _$uid,
    mode: FieldMode.member,
  );
  static List<String>? _$tags(TabBarNode v) => v.tags;
  static const Field<TabBarNode, List<String>> _f$tags = Field(
    'tags',
    _$tags,
    mode: FieldMode.member,
  );
  ...
  static const Field<TabBarNode, bool> _f$isExpanded = Field(
    'isExpanded',
    _$isExpanded,
    mode: FieldMode.member,
  );
  ...
  static const Field<TabBarNode, List<int>> _f$prevTabQ = Field(
    'prevTabQ',
    _$prevTabQ,
    mode: FieldMode.member,
  );
  static ValueNotifier<int> _$prevTabQSize(TabBarNode v) => v.prevTabQSize;
  static const Field<TabBarNode, ValueNotifier<int>> _f$prevTabQSize = Field(
    'prevTabQSize',
    _$prevTabQSize,
    mode: FieldMode.member,
  );
  static bool? _$backBtnPressed(TabBarNode v) => v.backBtnPressed;
  static const Field<TabBarNode, bool> _f$backBtnPressed = Field(
    'backBtnPressed',
    _$backBtnPressed,
    mode: FieldMode.member,
  );
...
mixin TabBarNodeMappable {
  String toJson() {
    return TabBarNodeMapper.ensureInitialized().encodeJson<TabBarNode>(
      this as TabBarNode,
    );
  }

  Map<String, dynamic> toMap() {
    return TabBarNodeMapper.ensureInitialized().encodeMap<TabBarNode>(
      this as TabBarNode,
    );
  }
  ...
  @override
  String toString() {
    return TabBarNodeMapper.ensureInitialized().stringifyValue(
      this as TabBarNode,
    );
  }
  ...
  bool operator ==(Object other) {
    return TabBarNodeMapper.ensureInitialized().equalsValue(
      this as TabBarNode,
      other,
    );
  }
...
class _TabBarNodeCopyWithImpl<$R, $Out>
  ...
  TabBarNode $make(CopyWithData data) => TabBarNode(
    ...
    selectedLabelColor: data.get(
      #selectedLabelColor,
      or: $value.selectedLabelColor,
    ),
    unselectedLabelColor: data.get(
      #unselectedLabelColor,
      or: $value.unselectedLabelColor,
    ),
