...
class AppInfoModelMapper extends ClassMapperBase<AppInfoModel> {
  ...
  static const Field<AppInfoModel, List<String>> _f$editorPasswords = Field(
    ...
    opt: true,
    def: const ['password123'],
  );
  static bool _$clipboardIsEmpty(AppInfoModel v) => v.clipboardIsEmpty;
  static const Field<AppInfoModel, bool> _f$clipboardIsEmpty = Field(
    'clipboardIsEmpty',
    _$clipboardIsEmpty,
  ...
  final MappableFields<AppInfoModel> fields = const {
    ...
    #clipboardIsEmpty: _f$clipboardIsEmpty,
  };
