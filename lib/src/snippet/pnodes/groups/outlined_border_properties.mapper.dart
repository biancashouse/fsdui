...
class OutlinedBorderPropertiesMapper
  ...
  static OutlinedBorderPropertiesMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = OutlinedBorderPropertiesMapper._(),
      );
  ...
  _f$outlinedBorderType = Field(
    'outlinedBorderType',
    _$outlinedBorderType,
    opt: true,
  );
...
mixin OutlinedBorderPropertiesMappable {
  ...
  >
  get copyWith =>
      _OutlinedBorderPropertiesCopyWithImpl<
        OutlinedBorderProperties,
        OutlinedBorderProperties
      >(this as OutlinedBorderProperties, $identity, $identity);
  @override
  String toString() {
    return OutlinedBorderPropertiesMapper.ensureInitialized().stringifyValue(
      this as OutlinedBorderProperties,
    );
  }

  @override
  bool operator ==(Object other) {
    return OutlinedBorderPropertiesMapper.ensureInitialized().equalsValue(
      this as OutlinedBorderProperties,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return OutlinedBorderPropertiesMapper.ensureInitialized().hashValue(
      this as OutlinedBorderProperties,
    );
  }
}
...
extension OutlinedBorderPropertiesValueCopy<$R, $Out>
  ...
  get $asOutlinedBorderProperties => $base.as(
    (v, t, t2) => _OutlinedBorderPropertiesCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _OutlinedBorderPropertiesCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({Object? side = $none, Object? outlinedBorderType = $none}) => $apply(
    FieldCopyWithData({
  ...
  OutlinedBorderProperties $make(CopyWithData data) => OutlinedBorderProperties(
    ...
    outlinedBorderType: data.get(
      #outlinedBorderType,
      or: $value.outlinedBorderType,
    ),
  );
