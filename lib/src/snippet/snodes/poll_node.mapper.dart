...
class PollNodeMapper extends SubClassMapperBase<PollNode> {
  ...
  static const Field<PollNode, String> _f$pollName =
      Field('pollName', _$pollName, opt: true, def: '');
  ...
  static const Field<PollNode, List<String>> _f$tags =
...
mixin PollNodeMappable {
  ...
  PollNodeCopyWith<PollNode, PollNode, PollNode> get copyWith =>
      _PollNodeCopyWithImpl<PollNode, PollNode>(
          this as PollNode, $identity, $identity);
  @override
  String toString() {
